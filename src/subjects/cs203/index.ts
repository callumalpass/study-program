...
export const cs203Quizzes = loadQuizzesFromGlob(quizModules);
export const cs203Exams = examsData as Exam[];
export const cs203Projects = projectsData as Project[];
export const cs203Exercises = loadExercisesFromGlob(exerciseModules);

// Topics still use TypeScript for Vite's ?raw markdown imports
export { cs203Topics } from './topics';
