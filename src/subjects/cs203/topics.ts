...
import topic1Sub1 from './content/topic-1/01-dfa-fundamentals.md?raw';
import topic1Sub2 from './content/topic-1/02-nfa-epsilon.md?raw';
import topic1Sub3 from './content/topic-1/03-subset-construction.md?raw';
import topic1Sub4 from './content/topic-1/04-dfa-minimization.md?raw';
import topic1Sub5 from './content/topic-1/05-state-elimination.md?raw';
import topic1Sub6 from './content/topic-1/06-closure-properties.md?raw';
import topic1Sub7 from './content/topic-1/07-pumping-lemma.md?raw';

// Topic 2: Regular Languages and Expressions
import topic2Content from './content/topic-2.md?raw';
import topic2Sub1 from './content/topic-2/01-regex-syntax.md?raw';
import topic2Sub2 from './content/topic-2/02-regex-semantics.md?raw';
import topic2Sub3 from './content/topic-2/03-fa-to-regex.md?raw';
import topic2Sub4 from './content/topic-2/04-regex-to-nfa.md?raw';
import topic2Sub5 from './content/topic-2/05-algebraic-properties.md?raw';
import topic2Sub6 from './content/topic-2/06-closure-properties.md?raw';
import topic2Sub7 from './content/topic-2/07-decision-problems.md?raw';

// Topic 3: Context-Free Grammars
import topic3Content from './content/topic-3.md?raw';
import topic3Sub1 from './content/topic-3/01-grammar-definition.md?raw';
import topic3Sub2 from './content/topic-3/02-derivations.md?raw';
import topic3Sub3 from './content/topic-3/03-parse-trees.md?raw';
import topic3Sub4 from './content/topic-3/04-ambiguity.md?raw';
import topic3Sub5 from './content/topic-3/05-normal-forms.md?raw';
import topic3Sub6 from './content/topic-3/06-pumping-lemma-cfl.md?raw';
import topic3Sub7 from './content/topic-3/07-closure-properties-cfl.md?raw';

// Topic 4: Pushdown Automata
import topic4Content from './content/topic-4.md?raw';
import topic4Sub1 from './content/topic-4/01-pda-definition.md?raw';
import topic4Sub2 from './content/topic-4/02-pda-computation.md?raw';
import topic4Sub3 from './content/topic-4/03-acceptance-modes.md?raw';
import topic4Sub4 from './content/topic-4/04-designing-pdas.md?raw';
import topic4Sub5 from './content/topic-4/05-pda-to-cfg.md?raw';
import topic4Sub6 from './content/topic-4/06-cfg-to-pda.md?raw';
import topic4Sub7 from './content/topic-4/07-dpda.md?raw';

// Topic 5: Turing Machines
import topic5Content from './content/topic-5.md?raw';
import topic5Sub1 from './content/topic-5/01-tm-definition.md?raw';
import topic5Sub2 from './content/topic-5/02-tm-computation.md?raw';
import topic5Sub3 from './content/topic-5/03-designing-tms.md?raw';
import topic5Sub4 from './content/topic-5/04-tm-variants.md?raw';
import topic5Sub5 from './content/topic-5/05-equivalence.md?raw';
import topic5Sub6 from './content/topic-5/06-universal-tm.md?raw';
import topic5Sub7 from './content/topic-5/07-church-turing.md?raw';

// Topic 6: Decidability and Computability
import topic6Content from './content/topic-6.md?raw';
import topic6Sub1 from './content/topic-6/01-decidable-languages.md?raw';
import topic6Sub2 from './content/topic-6/02-recognizable-languages.md?raw';
import topic6Sub3 from './content/topic-6/03-diagonalization.md?raw';
import topic6Sub4 from './content/topic-6/04-halting-problem.md?raw';
import topic6Sub5 from './content/topic-6/05-reductions.md?raw';
import topic6Sub6 from './content/topic-6/06-rices-theorem.md?raw';
import topic6Sub7 from './content/topic-6/07-decidability-automata.md?raw';

// Topic 7: Computational Complexity
import topic7Content from './content/topic-7.md?raw';
import topic7Sub1 from './content/topic-7/01-time-complexity.md?raw';
import topic7Sub2 from './content/topic-7/02-class-p.md?raw';
import topic7Sub3 from './content/topic-7/03-class-np.md?raw';
import topic7Sub4 from './content/topic-7/04-p-vs-np.md?raw';
import topic7Sub5 from './content/topic-7/05-np-completeness.md?raw';
import topic7Sub6 from './content/topic-7/06-polynomial-reductions.md?raw';
import topic7Sub7 from './content/topic-7/07-space-complexity.md?raw';
