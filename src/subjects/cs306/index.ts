...
export const cs306Quizzes = loadQuizzesFromGlob(quizModules);
export const cs306Exams = examsData as Exam[];
export const cs306Projects = projectsData as Project[];
export const cs306Exercises = loadExercisesFromGlob(exerciseModules);

// Topics still use TypeScript for Vite's ?raw markdown imports
export { cs306Topics } from './topics';
