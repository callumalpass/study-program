...
import topic1Sub1 from './content/topic-1/01-process-concept.md?raw';
import topic1Sub2 from './content/topic-1/02-process-control-block.md?raw';
import topic1Sub3 from './content/topic-1/03-process-scheduling.md?raw';
import topic1Sub4 from './content/topic-1/04-context-switch.md?raw';
import topic1Sub5 from './content/topic-1/05-process-operations.md?raw';
import topic1Sub6 from './content/topic-1/06-ipc-shared-memory.md?raw';
import topic1Sub7 from './content/topic-1/07-ipc-message-passing.md?raw';

// Topic 2: Threads and Concurrency
import topic2Content from './content/topic-2.md?raw';
import topic2Sub1 from './content/topic-2/01-thread-concept.md?raw';
import topic2Sub2 from './content/topic-2/02-multithreading-models.md?raw';
import topic2Sub3 from './content/topic-2/03-pthreads.md?raw';
import topic2Sub4 from './content/topic-2/04-thread-pools.md?raw';
import topic2Sub5 from './content/topic-2/05-thread-safety.md?raw';
import topic2Sub6 from './content/topic-2/06-thread-scheduling.md?raw';
import topic2Sub7 from './content/topic-2/07-implicit-threading.md?raw';

// Topic 3: CPU Scheduling
import topic3Content from './content/topic-3.md?raw';
import topic3Sub1 from './content/topic-3/01-scheduling-concepts.md?raw';
import topic3Sub2 from './content/topic-3/02-fcfs-sjf.md?raw';
import topic3Sub3 from './content/topic-3/03-round-robin.md?raw';
import topic3Sub4 from './content/topic-3/04-priority-scheduling.md?raw';
import topic3Sub5 from './content/topic-3/05-multilevel-queue.md?raw';
import topic3Sub6 from './content/topic-3/06-multiprocessor-scheduling.md?raw';
import topic3Sub7 from './content/topic-3/07-realtime-scheduling.md?raw';

// Topic 4: Synchronization
import topic4Content from './content/topic-4.md?raw';
import topic4Sub1 from './content/topic-4/01-critical-section.md?raw';
import topic4Sub2 from './content/topic-4/02-mutex-locks.md?raw';
import topic4Sub3 from './content/topic-4/03-semaphores.md?raw';
import topic4Sub4 from './content/topic-4/04-classic-problems.md?raw';
import topic4Sub5 from './content/topic-4/05-monitors.md?raw';
import topic4Sub6 from './content/topic-4/06-liveness.md?raw';
import topic4Sub7 from './content/topic-4/07-lock-free.md?raw';

// Topic 5: Deadlock
import topic5Content from './content/topic-5.md?raw';
import topic5Sub1 from './content/topic-5/01-deadlock-concepts.md?raw';
import topic5Sub2 from './content/topic-5/02-deadlock-prevention.md?raw';
import topic5Sub3 from './content/topic-5/03-deadlock-avoidance.md?raw';
import topic5Sub4 from './content/topic-5/04-deadlock-detection.md?raw';
import topic5Sub5 from './content/topic-5/05-deadlock-recovery.md?raw';
import topic5Sub6 from './content/topic-5/06-practical-deadlock.md?raw';
import topic5Sub7 from './content/topic-5/07-deadlock-examples.md?raw';

// Topic 6: Memory Management
import topic6Content from './content/topic-6.md?raw';
import topic6Sub1 from './content/topic-6/01-memory-basics.md?raw';
import topic6Sub2 from './content/topic-6/02-contiguous-allocation.md?raw';
import topic6Sub3 from './content/topic-6/03-paging.md?raw';
import topic6Sub4 from './content/topic-6/04-page-tables.md?raw';
import topic6Sub5 from './content/topic-6/05-tlb.md?raw';
import topic6Sub6 from './content/topic-6/06-segmentation.md?raw';
import topic6Sub7 from './content/topic-6/07-swapping.md?raw';

// Topic 7: Virtual Memory and File Systems
import topic7Content from './content/topic-7.md?raw';
import topic7Sub1 from './content/topic-7/01-virtual-memory.md?raw';
import topic7Sub2 from './content/topic-7/02-page-replacement.md?raw';
import topic7Sub3 from './content/topic-7/03-thrashing.md?raw';
import topic7Sub4 from './content/topic-7/04-memory-mapped-files.md?raw';
import topic7Sub5 from './content/topic-7/05-file-concepts.md?raw';
import topic7Sub6 from './content/topic-7/06-file-implementation.md?raw';
import topic7Sub7 from './content/topic-7/07-file-systems.md?raw';
