...
import topic1_1 from './content/topic-1/01-data-sources.md?raw';
import topic1_2 from './content/topic-1/02-web-scraping.md?raw';
import topic1_3 from './content/topic-1/03-apis.md?raw';
import topic1_4 from './content/topic-1/04-databases.md?raw';
import topic1_5 from './content/topic-1/05-data-formats.md?raw';
import topic1_6 from './content/topic-1/06-data-quality.md?raw';
import topic1_7 from './content/topic-1/07-data-governance.md?raw';

import topic2_1 from './content/topic-2/01-missing-data.md?raw';
import topic2_2 from './content/topic-2/02-outliers.md?raw';
import topic2_3 from './content/topic-2/03-data-transformation.md?raw';
import topic2_4 from './content/topic-2/04-normalization.md?raw';
import topic2_5 from './content/topic-2/05-encoding.md?raw';
import topic2_6 from './content/topic-2/06-data-validation.md?raw';
import topic2_7 from './content/topic-2/07-data-pipelines.md?raw';

import topic3_1 from './content/topic-3/01-descriptive-statistics.md?raw';
import topic3_2 from './content/topic-3/02-distributions.md?raw';
import topic3_3 from './content/topic-3/03-correlation.md?raw';
import topic3_4 from './content/topic-3/04-hypothesis-testing.md?raw';
import topic3_5 from './content/topic-3/05-statistical-inference.md?raw';
import topic3_6 from './content/topic-3/06-eda-process.md?raw';
import topic3_7 from './content/topic-3/07-eda-tools.md?raw';

import topic4_1 from './content/topic-4/01-feature-creation.md?raw';
import topic4_2 from './content/topic-4/02-feature-selection.md?raw';
import topic4_3 from './content/topic-4/03-feature-extraction.md?raw';
import topic4_4 from './content/topic-4/04-dimensionality-reduction.md?raw';
import topic4_5 from './content/topic-4/05-feature-scaling.md?raw';
import topic4_6 from './content/topic-4/06-encoding-features.md?raw';
import topic4_7 from './content/topic-4/07-automated-fe.md?raw';

import topic5_1 from './content/topic-5/01-visualization-principles.md?raw';
import topic5_2 from './content/topic-5/02-matplotlib-seaborn.md?raw';
import topic5_3 from './content/topic-5/03-interactive-viz.md?raw';
import topic5_4 from './content/topic-5/04-dashboards.md?raw';
import topic5_5 from './content/topic-5/05-storytelling.md?raw';
import topic5_6 from './content/topic-5/06-geospatial-viz.md?raw';
import topic5_7 from './content/topic-5/07-advanced-viz.md?raw';

import topic6_1 from './content/topic-6/01-big-data-intro.md?raw';
import topic6_2 from './content/topic-6/02-hadoop.md?raw';
import topic6_3 from './content/topic-6/03-spark-data.md?raw';
import topic6_4 from './content/topic-6/04-data-lakes.md?raw';
import topic6_5 from './content/topic-6/05-data-warehouses.md?raw';
import topic6_6 from './content/topic-6/06-etl.md?raw';
import topic6_7 from './content/topic-6/07-real-time-analytics.md?raw';

import topic7_1 from './content/topic-7/01-data-ethics.md?raw';
import topic7_2 from './content/topic-7/02-privacy.md?raw';
import topic7_3 from './content/topic-7/03-bias-fairness.md?raw';
import topic7_4 from './content/topic-7/04-transparency.md?raw';
import topic7_5 from './content/topic-7/05-regulations.md?raw';
import topic7_6 from './content/topic-7/06-responsible-ai.md?raw';
import topic7_7 from './content/topic-7/07-case-studies.md?raw';
