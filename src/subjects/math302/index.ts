...
export const math302Quizzes = loadQuizzesFromGlob(quizModules);
export const math302Exams = examsData as Exam[];
export const math302Exercises = loadExercisesFromGlob(exerciseModules);

// Topics still use TypeScript for Vite's ?raw markdown imports
export { math302Topics } from './topics';
