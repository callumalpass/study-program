...
export const cs105Quizzes = loadQuizzesFromGlob(quizModules);
export const cs105Exams = examsData as Exam[];
export const cs105Projects = projectsData as Project[];
export const cs105Exercises = loadExercisesFromGlob(exerciseModules);

// Topics still use TypeScript for Vite's ?raw markdown imports
export { cs105Topics } from './topics';
