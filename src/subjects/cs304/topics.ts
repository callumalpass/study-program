...
import topic1Sub1 from './content/topic-1/01-introduction-compilers.md?raw';
import topic1Sub2 from './content/topic-1/02-lexical-analysis-basics.md?raw';
import topic1Sub3 from './content/topic-1/03-regular-expressions.md?raw';
import topic1Sub4 from './content/topic-1/04-finite-automata.md?raw';
import topic1Sub5 from './content/topic-1/05-scanner-implementation.md?raw';
import topic1Sub6 from './content/topic-1/06-scanner-generators.md?raw';
import topic1Sub7 from './content/topic-1/07-error-handling.md?raw';

// Topic 2: Syntax Analysis
import topic2Sub1 from './content/topic-2/01-context-free-grammars.md?raw';
import topic2Sub2 from './content/topic-2/02-derivations-parse-trees.md?raw';
import topic2Sub3 from './content/topic-2/03-top-down-parsing.md?raw';
import topic2Sub4 from './content/topic-2/04-ll-parsing.md?raw';
import topic2Sub5 from './content/topic-2/05-bottom-up-parsing.md?raw';
import topic2Sub6 from './content/topic-2/06-lr-parsing.md?raw';
import topic2Sub7 from './content/topic-2/07-parser-generators.md?raw';

// Topic 3: Semantic Analysis
import topic3Sub1 from './content/topic-3/01-attribute-grammars.md?raw';
import topic3Sub2 from './content/topic-3/02-symbol-tables.md?raw';
import topic3Sub3 from './content/topic-3/03-type-checking.md?raw';
import topic3Sub4 from './content/topic-3/04-scope-resolution.md?raw';
import topic3Sub5 from './content/topic-3/05-type-inference.md?raw';
import topic3Sub6 from './content/topic-3/06-semantic-errors.md?raw';
import topic3Sub7 from './content/topic-3/07-ast-construction.md?raw';

// Topic 4: Intermediate Representations
import topic4Sub1 from './content/topic-4/01-ir-overview.md?raw';
import topic4Sub2 from './content/topic-4/02-three-address-code.md?raw';
import topic4Sub3 from './content/topic-4/03-control-flow-graphs.md?raw';
import topic4Sub4 from './content/topic-4/04-ssa-form.md?raw';
import topic4Sub5 from './content/topic-4/05-ir-lowering.md?raw';
import topic4Sub6 from './content/topic-4/06-ir-in-practice.md?raw';
import topic4Sub7 from './content/topic-4/07-ir-transformations.md?raw';

// Topic 5: Code Generation
import topic5Sub1 from './content/topic-5/01-target-machines.md?raw';
import topic5Sub2 from './content/topic-5/02-instruction-selection.md?raw';
import topic5Sub3 from './content/topic-5/03-register-allocation.md?raw';
import topic5Sub4 from './content/topic-5/04-instruction-scheduling.md?raw';
import topic5Sub5 from './content/topic-5/05-calling-conventions.md?raw';
import topic5Sub6 from './content/topic-5/06-stack-management.md?raw';
import topic5Sub7 from './content/topic-5/07-object-file-formats.md?raw';

// Topic 6: Optimization
import topic6Sub1 from './content/topic-6/01-optimization-overview.md?raw';
import topic6Sub2 from './content/topic-6/02-local-optimization.md?raw';
import topic6Sub3 from './content/topic-6/03-global-optimization.md?raw';
import topic6Sub4 from './content/topic-6/04-loop-optimization.md?raw';
import topic6Sub5 from './content/topic-6/05-data-flow-analysis.md?raw';
import topic6Sub6 from './content/topic-6/06-alias-analysis.md?raw';
import topic6Sub7 from './content/topic-6/07-interprocedural-optimization.md?raw';

// Topic 7: Runtime Systems
import topic7Sub1 from './content/topic-7/01-runtime-overview.md?raw';
import topic7Sub2 from './content/topic-7/02-memory-management.md?raw';
import topic7Sub3 from './content/topic-7/03-garbage-collection.md?raw';
import topic7Sub4 from './content/topic-7/04-exception-handling.md?raw';
import topic7Sub5 from './content/topic-7/05-virtual-machines.md?raw';
import topic7Sub6 from './content/topic-7/06-jit-compilation.md?raw';
import topic7Sub7 from './content/topic-7/07-linking-loading.md?raw';
