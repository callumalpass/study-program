...
export const math401Quizzes = loadQuizzesFromGlob(quizModules);
export const math401Exams = examsData as Exam[];
export const math401Exercises = loadExercisesFromGlob(exerciseModules);

// Topics still use TypeScript for Vite's ?raw markdown imports
export { math401Topics } from './topics';
