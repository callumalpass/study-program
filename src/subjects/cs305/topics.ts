...
import topic1_1 from './content/topic-1/01-html-introduction.md?raw';
import topic1_2 from './content/topic-1/02-document-structure.md?raw';
import topic1_3 from './content/topic-1/03-text-elements.md?raw';
import topic1_4 from './content/topic-1/04-links-images.md?raw';
import topic1_5 from './content/topic-1/05-forms-inputs.md?raw';
import topic1_6 from './content/topic-1/06-semantic-html.md?raw';
import topic1_7 from './content/topic-1/07-html-best-practices.md?raw';

import topic2_1 from './content/topic-2/01-css-introduction.md?raw';
import topic2_2 from './content/topic-2/02-selectors-specificity.md?raw';
import topic2_3 from './content/topic-2/03-box-model.md?raw';
import topic2_4 from './content/topic-2/04-flexbox.md?raw';
import topic2_5 from './content/topic-2/05-css-grid.md?raw';
import topic2_6 from './content/topic-2/06-positioning.md?raw';
import topic2_7 from './content/topic-2/07-css-variables.md?raw';

import topic3_1 from './content/topic-3/01-javascript-basics.md?raw';
import topic3_2 from './content/topic-3/02-variables-types.md?raw';
import topic3_3 from './content/topic-3/03-functions.md?raw';
import topic3_4 from './content/topic-3/04-objects-arrays.md?raw';
import topic3_5 from './content/topic-3/05-control-flow.md?raw';
import topic3_6 from './content/topic-3/06-error-handling.md?raw';
import topic3_7 from './content/topic-3/07-modules.md?raw';

import topic4_1 from './content/topic-4/01-dom-introduction.md?raw';
import topic4_2 from './content/topic-4/02-selecting-elements.md?raw';
import topic4_3 from './content/topic-4/03-modifying-dom.md?raw';
import topic4_4 from './content/topic-4/04-event-handling.md?raw';
import topic4_5 from './content/topic-4/05-event-delegation.md?raw';
import topic4_6 from './content/topic-4/06-form-validation.md?raw';
import topic4_7 from './content/topic-4/07-dom-performance.md?raw';

import topic5_1 from './content/topic-5/01-responsive-principles.md?raw';
import topic5_2 from './content/topic-5/02-media-queries.md?raw';
import topic5_3 from './content/topic-5/03-mobile-first.md?raw';
import topic5_4 from './content/topic-5/04-fluid-typography.md?raw';
import topic5_5 from './content/topic-5/05-responsive-images.md?raw';
import topic5_6 from './content/topic-5/06-css-frameworks.md?raw';
import topic5_7 from './content/topic-5/07-accessibility.md?raw';

import topic6_1 from './content/topic-6/01-async-programming.md?raw';
import topic6_2 from './content/topic-6/02-promises.md?raw';
import topic6_3 from './content/topic-6/03-async-await.md?raw';
import topic6_4 from './content/topic-6/04-fetch-api.md?raw';
import topic6_5 from './content/topic-6/05-rest-apis.md?raw';
import topic6_6 from './content/topic-6/06-error-handling-async.md?raw';
import topic6_7 from './content/topic-6/07-web-storage.md?raw';

import topic7_1 from './content/topic-7/01-build-tools.md?raw';
import topic7_2 from './content/topic-7/02-package-managers.md?raw';
import topic7_3 from './content/topic-7/03-bundlers.md?raw';
import topic7_4 from './content/topic-7/04-frameworks-overview.md?raw';
import topic7_5 from './content/topic-7/05-component-architecture.md?raw';
import topic7_6 from './content/topic-7/06-testing.md?raw';
import topic7_7 from './content/topic-7/07-deployment.md?raw';
