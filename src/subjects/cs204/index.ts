...
export const cs204Quizzes = loadQuizzesFromGlob(quizModules);
export const cs204Exams = examsData as Exam[];
export const cs204Projects = projectsData as Project[];
export const cs204Exercises = loadExercisesFromGlob(exerciseModules);

// Topics still use TypeScript for Vite's ?raw markdown imports
export { cs204Topics } from './topics';
