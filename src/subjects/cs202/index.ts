...
export const cs202Quizzes = loadQuizzesFromGlob(quizModules);
export const cs202Exams = examsData as Exam[];
export const cs202Projects = projectsData as Project[];
export const cs202Exercises = loadExercisesFromGlob(exerciseModules);

// Topics still use TypeScript for Vite's ?raw markdown imports
export { cs202Topics } from './topics';
