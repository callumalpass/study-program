...
export const math303Quizzes = loadQuizzesFromGlob(quizModules);
export const math303Exams = examsData as Exam[];
export const math303Exercises = loadExercisesFromGlob(exerciseModules);

// Topics still use TypeScript for Vite's ?raw markdown imports
export { math303Topics } from './topics';
