...
export const math101Quizzes = loadQuizzesFromGlob(quizModules);
export const math101Exams = examsData as Exam[];
export const math101Projects = projectsData as Project[];
export const math101Exercises = loadExercisesFromGlob(exerciseModules);
