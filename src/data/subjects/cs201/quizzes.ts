...
export const cs201Quizzes: Quiz[] = [
  // ============================================================================
  ...
  // ============================================================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Quick Sort', 'Selection Sort', 'Insertion Sort', 'Heap Sort'],
        correctAnswer: 2,
  ...
  },
  {
    ...
    return result`,
      ...
      },
      {
        ...
        options: ['1', 'log n', 'Half of remaining', 'n - 1'],
        correctAnswer: 2,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Sorted Array', 'Linked List', 'Hash Table', 'Binary Search Tree'],
        correctAnswer: 2,
  ...
  // ============================================================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Merge Sort', 'Quick Sort', 'Insertion Sort', 'Binary Search'],
        correctAnswer: 2,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['O(1)', 'O(m+n)', 'O(mn)', 'O(m^2 + n^2)'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Binary Search', 'Fibonacci Sequence', 'Quick Sort partition', 'Graph BFS'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Cycles', 'Disconnected components', 'Negative edge weights', 'More than 1000 vertices'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['O(V^2)', 'O(E log V)', 'O(V + E)', 'O(E * V)'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['O(V + E)', 'O(E log V)', 'O(V * E)', 'O(V^3)'],
        correctAnswer: 2,
  ...
  // ============================================================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Loop invariants', 'Mathematical induction', 'Empirical testing', 'Big-O analysis'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Sorting', 'Binary Search', 'Traveling Salesman (decision)', 'Finding GCD'],
        correctAnswer: 2,
