...
export const cs201Topic8Exercises: CodingExercise[] = [
  // 1-4: Implementing algorithms with explicit loop invariants
  {
    id: 'cs201-ex-8-1',
    subjectId: 'cs201',
    topicId: 'cs201-8',
    ...
    testCases: [
      { input: '[1, 2, 3, 4, 5], 3', expectedOutput: '2', isHidden: false, description: 'Target found at index 2' },
      { input: '[1, 2, 3, 4, 5], 6', expectedOutput: '-1', isHidden: false, description: 'Target not in array' },
      { input: '[10, 20, 30], 10', expectedOutput: '0', isHidden: false, description: 'Target at first position' },
  ...
  },
  {
    ...
    testCases: [
      ...
      { input: '[2, 4, 6, 8, 10], 2', expectedOutput: '0', isHidden: false, description: 'Target at beginning' },
      { input: '[2, 4, 6, 8, 10], 10', expectedOutput: '4', isHidden: true, description: 'Target at end' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '[1, 2, 3, 4, 5]', expectedOutput: '15', isHidden: false, description: 'Sum of 1 to 5' },
      { input: '[10, -5, 3]', expectedOutput: '8', isHidden: false, description: 'Mixed positive and negative' },
      { input: '[100]', expectedOutput: '100', isHidden: false, description: 'Single element' },
  ...
  },
  {
    ...
    testCases: [
      { input: '[5, 2, 4, 6, 1, 3]', expectedOutput: '[1, 2, 3, 4, 5, 6]', isHidden: false, description: 'Unsorted array' },
      { input: '[1, 2, 3]', expectedOutput: '[1, 2, 3]', isHidden: false, description: 'Already sorted' },
      { input: '[3, 2, 1]', expectedOutput: '[1, 2, 3]', isHidden: false, description: 'Reverse sorted' },
  ...
  // 5-8: Verifying algorithm correctness
  {
    id: 'cs201-ex-8-5',
    subjectId: 'cs201',
    topicId: 'cs201-8',
    ...
    testCases: [
      { input: '[1, 2, 3, 4, 5]', expectedOutput: 'True', isHidden: false, description: 'Sorted array' },
      { input: '[1, 3, 2, 4]', expectedOutput: 'False', isHidden: false, description: 'Unsorted array' },
      { input: '[5, 5, 5]', expectedOutput: 'True', isHidden: false, description: 'All equal elements' },
      { input: '[1]', expectedOutput: 'True', isHidden: true, description: 'Single element' },
      { input: '[]', expectedOutput: 'True', isHidden: true, description: 'Empty array' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '[1, 3, 5, 7, 9], 5, 2', expectedOutput: 'True', isHidden: false, description: 'Correct result' },
      { input: '[1, 3, 5, 7, 9], 4, -1', expectedOutput: 'True', isHidden: false, description: 'Correctly not found' },
      { input: '[1, 3, 5, 7, 9], 5, 3', expectedOutput: 'False', isHidden: false, description: 'Wrong index returned' },
      { input: '[1, 3, 5, 7, 9], 7, -1', expectedOutput: 'False', isHidden: true, description: 'Should have been found' },
      { input: '[5, 3, 1], 3, 1', expectedOutput: 'False', isHidden: true, description: 'Array not sorted' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '[3, 1, 2], [1, 2, 3]', expectedOutput: 'True', isHidden: false, description: 'Correctly sorted' },
      { input: '[3, 1, 2], [1, 2, 2]', expectedOutput: 'False', isHidden: false, description: 'Different elements' },
      { input: '[3, 1, 2], [1, 3]', expectedOutput: 'False', isHidden: false, description: 'Missing element' },
      { input: '[5, 5, 1], [1, 5, 5]', expectedOutput: 'True', isHidden: true, description: 'Duplicates handled correctly' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '[1, 5, 3, 2], 5', expectedOutput: 'True', isHidden: false, description: 'Correct max' },
      { input: '[1, 5, 3, 2], 3', expectedOutput: 'False', isHidden: false, description: 'Not the max' },
      { input: '[7, 7, 7], 7', expectedOutput: 'True', isHidden: false, description: 'All elements equal' },
      { input: '[1, 5, 3, 2], 10', expectedOutput: 'False', isHidden: true, description: 'Max not in array' },
      { input: '[], 5', expectedOutput: 'False', isHidden: true, description: 'Empty array' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '{\'A\': [\'B\'], \'B\': [\'C\'], \'C\': []}', expectedOutput: 'False', isHidden: false, description: 'No cycle - simple chain' },
      { input: '{\'A\': [\'B\'], \'B\': [\'C\'], \'C\': [\'A\']}', expectedOutput: 'True', isHidden: false, description: 'Cycle present' },
      { input: '{\'A\': [\'B\'], \'B\': [\'C\'], \'C\': [], \'D\': [\'E\'], \'E\': []}', expectedOutput: 'False', isHidden: false, description: 'Disconnected, no cycles' },
      { input: '{\'A\': [\'A\']}', expectedOutput: 'True', isHidden: true, description: 'Self-loop' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '"()"', expectedOutput: 'True', isHidden: false, description: 'Simple balanced' },
      { input: '"()[]{}"', expectedOutput: 'True', isHidden: false, description: 'Multiple types balanced' },
      { input: '"(]"', expectedOutput: 'False', isHidden: false, description: 'Mismatched types' },
      { input: '"(()"', expectedOutput: 'False', isHidden: false, description: 'Unclosed parenthesis' },
      { input: '"{[()]}"', expectedOutput: 'True', isHidden: true, description: 'Nested balanced' },
      { input: '"((()))"', expectedOutput: 'True', isHidden: true, description: 'Deep nesting' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '["x1", "-x2", "x3"], {"x1": True, "x2": True, "x3": False}', expectedOutput: 'True', isHidden: false, description: 'Satisfied by x1' },
      { input: '["x1", "-x2", "x3"], {"x1": False, "x2": True, "x3": False}', expectedOutput: 'True', isHidden: false, description: 'Satisfied by -x2' },
      { input: '["x1", "x2", "x3"], {"x1": False, "x2": False, "x3": False}', expectedOutput: 'False', isHidden: false, description: 'Not satisfied' },
      { input: '["-x1", "-x2", "-x3"], {"x1": False, "x2": False, "x3": True}', expectedOutput: 'True', isHidden: true, description: 'Satisfied by negated literals' }
    ],
    hints: [
