...
const questions: QuizQuestion[] = [
  // Topic 1: NP-Completeness Review — Quiz 1 (Fundamentals)
  {
    id: 'cs403-q1',
  ...
  // Topic 2: Approximation Algorithms — Quiz 1 (Fundamentals)
  {
    id: 'cs403-q16',
    type: 'multiple_choice',
  ...
  },
  {
    ...
    options: ['Maximum matching', 'Minimum spanning tree', 'Shortest paths', 'Dynamic programming'],
  ...
  },
  {
    ...
    options: ['A 2-approximation', 'A 1.5-approximation', 'An exact solution', 'No approximation guarantee'],
  ...
  },
  {
    ...
    options: ['Linear programming duality', 'Divide-and-conquer recurrences', 'Random sampling', 'Amortized analysis'],
  ...
  // Topic 3: Randomized Algorithms — Quiz 1 (Fundamentals)
  {
    id: 'cs403-q31',
    type: 'multiple_choice',
  ...
  },
  {
    ...
    options: ['Amplification via repetition and majority vote', 'Memoization', 'Topological sorting', 'Dynamic programming'],
  ...
  // Topic 4: Online Algorithms — Quiz 1 (Fundamentals)
  {
    id: 'cs403-q46',
    type: 'multiple_choice',
  ...
  },
  {
    ...
    options: ['n/e candidates', 'n/2 candidates', 'n/3 candidates', 'log n candidates'],
  ...
  },
  {
    ...
    options: ['LRU', 'OPT', 'An offline algorithm', 'A clairvoyant algorithm'],
    correctAnswer: 'LRU',
  ...
  // Topic 5: Advanced Dynamic Programming — Quiz 1 (Fundamentals)
  {
    id: 'cs403-q61',
    type: 'multiple_choice',
  ...
  },
  {
    ...
    options: ['String similarity', 'Maximum flow', 'Convex hull', 'Set cover'],
  ...
  },
  {
    ...
    options: ['Subsets', 'Trees only', 'Matrices only', 'Greedy choices'],
  ...
  },
  {
    ...
    options: ['Keeping only the previous row/column when transitions are local', 'Using recursion instead of iteration', 'Sorting the input first', 'Using a heap'],
  ...
  },
  {
    ...
    options: ['An endpoint/last element', 'A random seed', 'A hash function', 'A heap size'],
  ...
  // Topic 6: Network Flow Algorithms — Quiz 1 (Fundamentals)
  {
    id: 'cs403-q76',
    type: 'multiple_choice',
    prompt: 'A flow network is typically a:',
    options: ['Directed graph with capacities', 'Undirected graph with weights', 'Tree with priorities', 'Planar graph only'],
  ...
  },
  {
    ...
    options: ['BFS (shortest in edges)', 'DFS (deepest first)', 'Dijkstra', 'Bellman–Ford'],
  ...
  },
  {
    ...
    options: ['Total edge cost of the shipped flow', 'Number of vertices used', 'Graph diameter', 'Maximum degree'],
  ...
  },
  {
    ...
    options: ['Project selection / closure problems', 'Sorting numbers', 'Computing convex hull', 'Finding primes'],
  ...
  // Topic 7: Computational Geometry — Quiz 1 (Fundamentals)
  {
    id: 'cs403-q91',
    type: 'multiple_choice',
  ...
  },
  {
    ...
    options: ['Range tree', 'Heap', 'Union-find', 'Trie'],
  ...
  },
  {
    ...
    options: ['O(nh)', 'O(n log n)', 'O(n^2)', 'O(h log n)'],
    correctAnswer: 'O(nh)',
