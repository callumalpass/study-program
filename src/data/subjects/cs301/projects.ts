...
export const cs301Projects: Project[] = [
  {
    id: 'cs301-project-1',
    subjectId: 'cs301',
    title: 'Process Scheduler Simulator',
    description: `
Design and implement a process scheduler simulator that demonstrates various CPU scheduling algorithms.
...
This project integrates concepts from process management, CPU scheduling, and performance analysis to give you hands-on experience with how operating systems make scheduling decisions.
    ...
    rubric: [
      {
        ...
        weight: 30,
        levels: [
          { score: 4, label: 'Excellent', description: 'All 4+ algorithms implemented correctly with preemptive/non-preemptive variants' },
          { score: 3, label: 'Good', description: 'All algorithms work correctly in basic scenarios' },
          { score: 2, label: 'Satisfactory', description: 'Most algorithms implemented with minor bugs' },
          { score: 1, label: 'Needs Improvement', description: 'Fewer than 3 algorithms or significant bugs' },
        ],
      },
      {
        ...
        weight: 25,
        levels: [
          { score: 4, label: 'Excellent', description: 'All metrics calculated correctly; handles edge cases' },
          { score: 3, label: 'Good', description: 'Metrics generally correct with minor issues' },
          { score: 2, label: 'Satisfactory', description: 'Basic metrics work but some calculations incorrect' },
          { score: 1, label: 'Needs Improvement', description: 'Metrics frequently incorrect or missing' },
        ],
      },
      {
        name: 'Visualization',
        weight: 20,
        levels: [
          { score: 4, label: 'Excellent', description: 'Clear, informative Gantt chart with timing details' },
          { score: 3, label: 'Good', description: 'Working visualization that shows process order' },
          { score: 2, label: 'Satisfactory', description: 'Basic output showing schedule' },
          { score: 1, label: 'Needs Improvement', description: 'No visualization or output unclear' },
        ],
      },
      {
        ...
        weight: 25,
        levels: [
          { score: 4, label: 'Excellent', description: 'Well-organized code; clear documentation; good modularity' },
          { score: 3, label: 'Good', description: 'Readable code with some documentation' },
          { score: 2, label: 'Satisfactory', description: 'Code works but organization could improve' },
          { score: 1, label: 'Needs Improvement', description: 'Difficult to read or understand' },
        ],
      },
    ],
    estimatedHours: 12,
  ...
  },
  {
    ...
    description: `
Implement a virtual memory management simulator that demonstrates page replacement algorithms and memory allocation strategies.
    ...
    rubric: [
      {
        ...
        weight: 35,
        levels: [
          { score: 4, label: 'Excellent', description: 'All algorithms implemented correctly including Clock/Second-Chance' },
          { score: 3, label: 'Good', description: 'FIFO, LRU, and Optimal work correctly' },
          { score: 2, label: 'Satisfactory', description: 'Most algorithms work with minor issues' },
          { score: 1, label: 'Needs Improvement', description: 'Algorithms produce incorrect results' },
        ],
      },
      {
        ...
        weight: 20,
        levels: [
          { score: 4, label: 'Excellent', description: 'Multiple patterns including locality simulation' },
          { score: 3, label: 'Good', description: 'Random and sequential patterns supported' },
          { score: 2, label: 'Satisfactory', description: 'Can generate basic reference strings' },
          { score: 1, label: 'Needs Improvement', description: 'Limited or no reference generation' },
        ],
      },
      {
        ...
        weight: 25,
        levels: [
          { score: 4, label: 'Excellent', description: 'Comprehensive stats with comparison charts/tables' },
          { score: 3, label: 'Good', description: 'Page faults and hit rates calculated correctly' },
          { score: 2, label: 'Satisfactory', description: 'Basic statistics provided' },
          { score: 1, label: 'Needs Improvement', description: 'Statistics missing or incorrect' },
        ],
      },
      {
        ...
        weight: 20,
        levels: [
          { score: 4, label: 'Excellent', description: 'Step-by-step visualization of frame state changes' },
          { score: 3, label: 'Good', description: 'Clear output showing replacement decisions' },
          { score: 2, label: 'Satisfactory', description: 'Basic output of final results' },
          { score: 1, label: 'Needs Improvement', description: 'Output unclear or missing' },
        ],
      },
    ],
    estimatedHours: 10,
