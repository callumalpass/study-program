...
export const cs301Exams: Exam[] = [
  {
    ...
    questions: [
      // ========== Topic 1: Process Management (5 questions) ==========
      {
        id: 'mid-q1',
      ...
      // ========== Topic 2: Threads and Concurrency (5 questions) ==========
      {
        id: 'mid-q6',
        type: 'multiple_choice',
        prompt: 'Which of the following is shared between threads of the same process?',
        options: ['Stack', 'Program counter', 'Registers', 'Code and data sections'],
        correctAnswer: 3,
...
int main() {
    ...
    return 0;
        ...
        testCases: [
          { input: '', expectedOutput: 'Hello from thread', isHidden: false, description: 'Thread prints message' }
        ],
        correctAnswer: true,
      ...
      // ========== Topic 3: CPU Scheduling (6 questions) ==========
      {
        id: 'mid-q11',
        type: 'multiple_choice',
...
P1 waits: 6
Average = ?`,
        options: ['2.67', '4.67', '8/3', 'Both A and C'],
        correctAnswer: 3,
      ...
      // ========== Topic 4: Synchronization (8 questions) ==========
      {
        id: 'mid-q17',
        type: 'multiple_choice',
      ...
      },
      {
        ...
        options: ['Mutual exclusion', 'Progress', 'Bounded waiting', 'Simultaneous access'],
        correctAnswer: 3,
...
void consumer() {
    while (true) {
        ...
        testCases: [
          { input: '', expectedOutput: 'Correct synchronization', isHidden: false, description: 'Producer-consumer sync' }
        ],
        correctAnswer: true,
      ...
      },
      {
        ...
        options: ['Mutex locks', 'Semaphores', 'Compare-and-swap (CAS)', 'Condition variables'],
        correctAnswer: 2,
...
11-12: P3 (done)`,
  ...
  },
  {
    ...
    questions: [
      // ========== Topics 1-4 Review (8 questions) ==========
      {
        id: 'fin-q1',
        type: 'multiple_choice',
        prompt: 'Which process state transition is NOT possible?',
        options: ['Running → Waiting', 'Ready → Running', 'Waiting → Running', 'Running → Ready'],
        correctAnswer: 2,
...
void leave_section(int i) {
    flag[i] = 0;        // I'm leaving
        ...
        testCases: [
          { input: '', expectedOutput: 'Mutual exclusion achieved', isHidden: false, description: 'Peterson\'s algorithm' }
        ],
        correctAnswer: true,
      ...
      },
      {
        ...
        options: ['Process size', 'Arrival time', 'Period (shorter period = higher priority)', 'Execution time'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Prevention', 'Avoidance', 'Detection and recovery', 'Ostrich algorithm (ignore it)'],
        correctAnswer: 3,
...
Available = [3,3,2]`,
        options: ['Yes, safe sequence: P1,P3,P4,P2,P0', 'Yes, safe sequence: P1,P3,P4,P0,P2', 'No, not safe', 'Cannot determine'],
        correctAnswer: 0,
      ...
      // ========== Topic 6: Memory Management (8 questions) ==========
      {
        id: 'fin-q15',
        type: 'multiple_choice',
        prompt: 'External fragmentation is a problem in which allocation scheme?',
        options: ['Paging', 'Contiguous allocation', 'Both', 'Neither'],
        correctAnswer: 1,
...
4096 = 2^?`,
        options: ['10 bits', '11 bits', '12 bits', '13 bits'],
        correctAnswer: 2,
    ...
    return physical_addr`,
        testCases: [
          { input: 'translate(5000, [2, 3, 0, 5], 4096)', expectedOutput: '13192', isHidden: false, description: 'Page 1, offset 904' },
          { input: 'translate(0, [5], 4096)', expectedOutput: '20480', isHidden: false, description: 'First byte' }
        ],
        correctAnswer: true,
      ...
      // ========== Topic 7: Virtual Memory and File Systems (10 questions) ==========
      {
        id: 'fin-q23',
        type: 'multiple_choice',
...
Track LRU order after each reference...`,
      ...
      },
      {
        ...
        options: ['FIFO', 'LRU', 'OPT (Optimal)', 'Clock'],
        correctAnswer: 2,
...
Single indirect block = 1024 × 4KB = ?`,
      ...
      // ========== Comprehensive Questions ==========
      {
        ...
        options: ['Compression', 'Encryption', 'Journaling', 'Quotas'],
        correctAnswer: 2,
    ...
    return page_faults`,
        testCases: [
          { input: '[1, 2, 3, 4, 1, 2, 5, 1, 2, 3, 4, 5], 3', expectedOutput: '9', isHidden: false, description: 'Standard reference string' },
          { input: '[1, 2, 3, 1, 2, 3], 3', expectedOutput: '3', isHidden: false, description: 'No replacements needed' }
        ],
        correctAnswer: true,
