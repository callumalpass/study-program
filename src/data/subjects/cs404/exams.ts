...
export const cs404Exams: Exam[] = [
  {
    ...
    durationMinutes: 75,
    questions: [
      // Topic 1: Project Planning (7 questions)
      {
        id: 'q1',
      ...
      // Topic 2: Architecture and Design (7 questions)
      {
        id: 'q8',
        type: 'multiple_choice',
      ...
      // Topic 3: Implementation Sprint 1 (7 questions)
      {
        id: 'q15',
        type: 'multiple_choice',
...
console.log(calculateEmissions(100, 'car'));`,
      ...
      // Topic 4: Implementation Sprint 2 (7 questions)
      {
        id: 'q22',
        type: 'multiple_choice',
...
console.log(result);`,
      ...
      // Additional questions to reach 28 total
      {
        id: 'q29',
        type: 'multiple_choice',
  ...
  },
  {
    ...
    durationMinutes: 120,
    questions: [
      // Topic 1: Project Planning (6 questions)
      {
        id: 'q1',
        type: 'multiple_choice',
      ...
      // Topic 2: Architecture and Design (6 questions)
      {
        id: 'q7',
        type: 'multiple_choice',
...
console.log(carCalculator.calculate(50));`,
      ...
      // Topic 3: Implementation Sprint 1 (6 questions)
      {
        id: 'q13',
        type: 'multiple_choice',
...
console.log(totalDistance);`,
      ...
      // Topic 4: Implementation Sprint 2 (6 questions)
      {
        id: 'q19',
        type: 'multiple_choice',
  ...
  return (
    <div>
      ...
      // Topic 5: Testing and Quality Assurance (6 questions)
      {
        id: 'q25',
        type: 'multiple_choice',
      ...
      // Topic 6: Deployment and DevOps (6 questions)
      {
        id: 'q31',
        type: 'multiple_choice',
      ...
      // Topic 7: Documentation and Presentation (6 questions)
      {
        id: 'q37',
        type: 'multiple_choice',
      ...
      // Additional questions to reach 43 total
      {
        id: 'q43',
        type: 'multiple_choice',
