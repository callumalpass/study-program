...
def curl_3d(P, Q, R, point):
    ...
    return curl`,
    testCases: [
      { input: '[round(x, 5) for x in curl_3d(lambda x,y,z: 0, lambda x,y,z: 0, lambda x,y,z: 0, (1, 1, 1))]', isHidden: false, description: 'Test case' },
      { input: '[round(x, 5) for x in curl_3d(lambda x,y,z: -y, lambda x,y,z: x, lambda x,y,z: 0, (0, 0, 0))]', isHidden: false, description: 'Test case' },
      { input: '[round(x, 5) for x in curl_3d(lambda x,y,z: y*z, lambda x,y,z: x*z, lambda x,y,z: x*y, (1, 1, 1))]', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
...
def divergence_3d(P, Q, R, point):
    ...
    testCases: [
      { input: 'round(divergence_3d(lambda x,y,z: x, lambda x,y,z: y, lambda x,y,z: z, (0, 0, 0)), 5)', isHidden: false, description: 'Test case' },
      { input: 'round(divergence_3d(lambda x,y,z: x**2, lambda x,y,z: y**2, lambda x,y,z: z**2, (1, 1, 1)), 5)', isHidden: false, description: 'Test case' },
      { input: 'round(divergence_3d(lambda x,y,z: -y, lambda x,y,z: x, lambda x,y,z: 0, (1, 1, 1)), 10)', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
      'div F = ∇·F = ∂P/∂x + ∂Q/∂y + ∂R/∂z',
...
def curl_2d(P, Q, point):
    ...
    return dQ_dx - dP_dy`,
    testCases: [
      { input: 'round(curl_2d(lambda x, y: -y, lambda x, y: x, (0, 0)), 5)', isHidden: false, description: 'Test case' },
      { input: 'round(curl_2d(lambda x, y: y, lambda x, y: x, (1, 1)), 10)', isHidden: false, description: 'Test case' },
      { input: 'round(curl_2d(lambda x, y: x*y, lambda x, y: x**2, (2, 1)), 5)', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
...
def is_irrotational(P, Q, R, test_points):
    ...
    return True`,
    testCases: [
      { input: 'is_irrotational(lambda x,y,z: y*z, lambda x,y,z: x*z, lambda x,y,z: x*y, [(0,0,0), (1,1,1)])', isHidden: false, description: 'Test case' },
      { input: 'is_irrotational(lambda x,y,z: -y, lambda x,y,z: x, lambda x,y,z: 0, [(1,1,1)])', isHidden: false, description: 'Test case' },
      { input: 'is_irrotational(lambda x,y,z: 2*x, lambda x,y,z: 2*y, lambda x,y,z: 2*z, [(1,1,1), (0,0,1)])', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
...
def is_incompressible(P, Q, R, test_points):
    ...
    return True`,
    testCases: [
      { input: 'is_incompressible(lambda x,y,z: -y, lambda x,y,z: x, lambda x,y,z: 0, [(0,0,0), (1,1,1)])', isHidden: false, description: 'Test case' },
      { input: 'is_incompressible(lambda x,y,z: x, lambda x,y,z: y, lambda x,y,z: z, [(1,1,1)])', isHidden: false, description: 'Test case' },
      { input: 'is_incompressible(lambda x,y,z: y, lambda x,y,z: -x, lambda x,y,z: z**2, [(1,1,1), (0,0,1)])', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
...
def verify_greens_theorem(P, Q, r, t_bounds, region_bounds):
    ...
    testCases: [
      { input: 'tuple(round(x, 5) for x in verify_greens_theorem(lambda x,y: 0, lambda x,y: x, lambda t: [np.cos(t), np.sin(t)], (0, 2*np.pi), ((-1, 1), (-1, 1))))', isHidden: false, description: 'Test case' },
      { input: 'tuple(round(x, 5) for x in verify_greens_theorem(lambda x,y: -y, lambda x,y: x, lambda t: [np.cos(t), np.sin(t)], (0, 2*np.pi), ((-1, 1), (-1, 1))))', isHidden: false, description: 'Test case' }
    ],
    hints: [
...
def area_greens(r, t_bounds):
    ...
    return abs(result) / 2`,
    testCases: [
      { input: 'round(area_greens(lambda t: [np.cos(t), np.sin(t)], (0, 2*np.pi)), 5)', isHidden: false, description: 'Test case' },
      { input: 'round(area_greens(lambda t: [2*np.cos(t), 2*np.sin(t)], (0, 2*np.pi)), 5)', isHidden: false, description: 'Test case' },
      { input: 'round(area_greens(lambda t: [t, 0] if t <= 1 else [1, t-1] if t <= 2 else [2-t, 1] if t <= 3 else [0, 4-t], (0, 4)), 5)', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
...
def verify_stokes(P, Q, R, boundary_curve, t_bounds, surface, u_bounds, v_bounds):
    ...
    testCases: [
      { input: 'tuple(round(x, 5) for x in verify_stokes(lambda x,y,z: -y, lambda x,y,z: x, lambda x,y,z: 0, lambda t: [np.cos(t), np.sin(t), 0], (0, 2*np.pi), lambda u,v: [u*np.cos(v), u*np.sin(v), 0], (0, 1), (0, 2*np.pi)))', isHidden: false, description: 'Test case' }
    ],
    hints: [
...
def verify_divergence_theorem(P, Q, R, volume_bounds, surface, u_bounds, v_bounds):
    ...
    testCases: [
      { input: 'tuple(round(x, 5) for x in verify_divergence_theorem(lambda x,y,z: x, lambda x,y,z: y, lambda x,y,z: z, ((-1, 1), (-1, 1), (-1, 1)), lambda u,v: [np.sin(v)*np.cos(u), np.sin(v)*np.sin(u), np.cos(v)], (0, 2*np.pi), (0, np.pi)))', isHidden: false, description: 'Test case' }
    ],
    hints: [
...
def laplacian(f, point):
    ...
    testCases: [
      { input: 'round(laplacian(lambda x, y, z: x**2 + y**2 + z**2, (0, 0, 0)), 5)', isHidden: false, description: 'Test case' },
      { input: 'round(laplacian(lambda x, y, z: x**3 + y**3 + z**3, (1, 1, 1)), 5)', isHidden: false, description: 'Test case' },
      { input: 'round(laplacian(lambda x, y, z: np.sin(x) + np.cos(y) + z, (0, 0, 0)), 10)', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
...
def is_harmonic(f, test_points):
    ...
    return True`,
    testCases: [
      { input: 'is_harmonic(lambda x, y, z: x**2 - y**2, [(1, 1, 0), (2, 1, 0)])', isHidden: false, description: 'Test case' },
      { input: 'is_harmonic(lambda x, y, z: x**2 + y**2 + z**2, [(1, 1, 1)])', isHidden: false, description: 'Test case' },
      { input: 'is_harmonic(lambda x, y, z: x*y*z, [(1, 1, 1), (0, 0, 1)])', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
...
def verify_div_curl_zero(P, Q, R, test_points):
    ...
    return True`,
    testCases: [
      { input: 'verify_div_curl_zero(lambda x,y,z: x*y, lambda x,y,z: y*z, lambda x,y,z: x*z, [(1, 1, 1)])', isHidden: false, description: 'Test case' },
      { input: 'verify_div_curl_zero(lambda x,y,z: x**2, lambda x,y,z: y**2, lambda x,y,z: z**2, [(0, 0, 0), (1, 1, 1)])', isHidden: false, description: 'Test case' }
    ],
    hints: [
...
def verify_curl_grad_zero(f, test_points):
    ...
    return True`,
    testCases: [
      { input: 'verify_curl_grad_zero(lambda x, y, z: x**2 + y**2 + z**2, [(1, 1, 1)])', isHidden: false, description: 'Test case' },
      { input: 'verify_curl_grad_zero(lambda x, y, z: x*y*z, [(0, 0, 0), (1, 1, 1)])', isHidden: false, description: 'Test case' },
      { input: 'verify_curl_grad_zero(lambda x, y, z: np.sin(x) * np.cos(y) * z, [(1, 1, 1)])', isHidden: true, description: 'Hidden test' }
    ],
    hints: [
      'Mathematical identity: ∇×(∇f) = 0 always',
...
def verify_gauss_law(E_x, E_y, E_z, charge_density, test_points, epsilon_0=1.0):
    ...
    return True`,
    testCases: [
      { input: 'verify_gauss_law(lambda x,y,z: x, lambda x,y,z: y, lambda x,y,z: z, lambda x,y,z: 3, [(0,0,0), (1,1,1)])', isHidden: false, description: 'Test case' },
      { input: 'verify_gauss_law(lambda x,y,z: 0, lambda x,y,z: 0, lambda x,y,z: 0, lambda x,y,z: 0, [(1,1,1)])', isHidden: false, description: 'Test case' }
    ],
    hints: [
      'Gauss\'s law: ∇·E = ρ/ε₀',
...
def verify_heat_equation(u, alpha, test_points):
    ...
    return True`,
    testCases: [
      { input: 'verify_heat_equation(lambda x,y,z,t: np.exp(-t) * np.sin(x), 1.0, [(0,0,0,1), (np.pi/2,0,0,0.5)])', isHidden: false, description: 'Test case' },
      { input: 'verify_heat_equation(lambda x,y,z,t: np.exp(-3*t) * (np.sin(x) + np.sin(y) + np.sin(z)), 1.0, [(0,0,0,0.1)])', isHidden: false, description: 'Test case' }
    ],
    hints: [
...
def helmholtz_decomposition_test(P, Q, R, test_point):
    ...
    return result`,
    testCases: [
      { input: 'helmholtz_decomposition_test(lambda x,y,z: x, lambda x,y,z: y, lambda x,y,z: z, (1,1,1))[\"is_purely_conservative\"]', isHidden: false, description: 'Test case' },
      { input: 'helmholtz_decomposition_test(lambda x,y,z: -y, lambda x,y,z: x, lambda x,y,z: 0, (1,1,1))[\"is_purely_solenoidal\"]', isHidden: false, description: 'Test case' }
    ],
    hints: [
