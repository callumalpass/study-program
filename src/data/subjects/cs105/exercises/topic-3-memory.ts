...
export const topic3Exercises: CodingExercise[] = [
  // EXISTING exercise - preserve ID
  {
    ...
    testCases: [
      { input: '', expectedOutput: '1 2 3 4 5', isHidden: false, description: 'Print array of 5 elements' },
      { input: '', expectedOutput: '1 2 3 4 5', isHidden: true, description: 'Verify memory allocation and deallocation' }
    ],
  ...
  },
  {
    ...
    solution: '#include <stdio.h>\n#include <stdlib.h>\n\nint main() {\n    int *arr1 = (int *)malloc(3 * sizeof(int));\n    int *arr2 = (int *)calloc(3, sizeof(int));\n    \n    printf("calloc: %d %d %d\\n", arr2[0], arr2[1], arr2[2]);\n    \n    free(arr1);\n    free(arr2);\n    return 0;\n}',
    testCases: [
      { input: '', expectedOutput: 'calloc: 0 0 0', isHidden: false, description: 'calloc initializes to 0' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: 'Hello World', isHidden: false, description: 'Print dynamic string' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: '1 2 3 4 5', isHidden: false, description: 'Resized array' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: '1 2 3 \n4 5 6 \n7 8 9', isHidden: false, description: '3x3 matrix' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: 'Allocated successfully!', isHidden: false, description: 'Safe allocation' }
    ],
  ...
  },
  {
    ...
    solution: '#include <stdio.h>\n#include <stdlib.h>\n\nvoid myMemcpy(void *dest, void *src, int n) {\n    char *d = (char *)dest;\n    char *s = (char *)src;\n    for (int i = 0; i < n; i++) {\n        d[i] = s[i];\n    }\n}\n\nint main() {\n    int src[] = {1, 2, 3, 4, 5};\n    int *dest = (int *)malloc(5 * sizeof(int));\n    \n    myMemcpy(dest, src, 5 * sizeof(int));\n    \n    for (int i = 0; i < 5; i++) {\n        printf("%d ", dest[i]);\n    }\n    \n    free(dest);\n    return 0;\n}',
    testCases: [
      { input: '', expectedOutput: '1 2 3 4 5', isHidden: false, description: 'Copy memory' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: '3 2 1', isHidden: false, description: 'Stack LIFO' }
    ],
