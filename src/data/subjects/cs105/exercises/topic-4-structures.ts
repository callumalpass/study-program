...
export const topic4Exercises: CodingExercise[] = [
  ...
  },
  {
    ...
    testCases: [],
    hints: ['Add real parts together, imaginary parts together', 'FOIL for multiplication'],
    language: 'c'
  },
  {
    id: 'cs105-t4-ex10',
    ...
    testCases: [],
    hints: ['Compare year first, then month, then day', 'Return difference to indicate direction'],
    language: 'c'
  },
  {
    id: 'cs105-t4-ex11',
    ...
    testCases: [],
    hints: ['Area = PI * r^2', 'Point inside if distance to center <= radius'],
    language: 'c'
  },
  {
    id: 'cs105-t4-ex12',
    ...
    testCases: [],
    hints: ['Swap entire structures when swapping', 'Compare emps[j].salary'],
    language: 'c'
  },
  {
    id: 'cs105-t4-ex13',
    ...
    testCases: [],
    hints: ['Use double pointer to modify head', 'Handle deleting head node specially'],
    language: 'c'
  },
  {
    id: 'cs105-t4-ex14',
    ...
    testCases: [],
    hints: ['Struct members are stored sequentially', 'Union members share same memory'],
    language: 'c'
  },
  {
    id: 'cs105-t4-ex15',
    ...
    testCases: [],
    hints: ['Total is 8 bits = 1 byte, but alignment may increase size', 'Values are truncated to bit width'],
    language: 'c'
  },
  {
    id: 'cs105-t4-ex16',
    ...
    testCases: [],
    hints: ['Order largest to smallest alignment', 'Group chars together to share padding'],
    language: 'c'
  }
];
