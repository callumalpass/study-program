...
export const topic4Exercises: CodingExercise[] = [
  // EXISTING exercise - preserve ID
  {
    ...
    testCases: [
      { input: '', expectedOutput: 'Name: John Doe\nID: 12345\nGPA: 3.80', isHidden: false, description: 'Print student record' },
      { input: '', expectedOutput: 'Name: John Doe\nID: 12345\nGPA: 3.80', isHidden: true, description: 'Verify structure definition' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: 'Distance: 5.00', isHidden: false, description: '3-4-5 triangle' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: 'Area: 15', isHidden: false, description: '5 * 3 = 15' }
    ],
  ...
  },
  {
    ...
    solution: '#include <stdio.h>\n\ntypedef struct {\n    int x;\n    int y;\n} Point;\n\nvoid movePoint(Point *p, int dx, int dy) {\n    p->x += dx;\n    p->y += dy;\n}\n\nint main() {\n    Point p = {5, 10};\n    movePoint(&p, 3, -2);\n    printf("Point: (%d, %d)", p.x, p.y);\n    return 0;\n}',
    testCases: [
      { input: '', expectedOutput: 'Point: (8, 8)', isHidden: false, description: '5+3=8, 10-2=8' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: 'Name: Alice\nAddress: 123 Main St, Boston', isHidden: false, description: 'Nested struct' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: 'Most expensive: Milk ($3.00)', isHidden: false, description: 'Find max price' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: '1 2 3', isHidden: false, description: 'Print linked list' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '', expectedOutput: 'Size of struct A: 12\nSize of struct B: 8', isHidden: false, description: 'Padding difference' }
    ],
