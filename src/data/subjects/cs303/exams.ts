    ...
    questions: [
      {
        ...
        options: ['Imperative', 'Object-oriented', 'Functional', 'Logic'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Focus on state mutation', 'Specifying how to compute', 'Specifying what to compute', 'Using classes'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Inheriting methods', 'Bundling data with methods and controlling access', 'Creating multiple forms', 'Using interfaces'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Creating singletons', 'Multiple inheritance only', 'Treating different types uniformly', 'Static type checking'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Memory management', 'Exploring alternative solutions', 'Type checking', 'Code optimization'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Manual type annotations', 'Automatic deduction of types', 'Type coercion', 'Dynamic typing'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Input positions only', 'Output positions only', 'Both positions', 'Neither position'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Type names', 'Type structure/shape', 'Inheritance hierarchy', 'Declaration order'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Only static types', 'Only dynamic types', 'Mixing static and dynamic typing', 'No type checking'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Must always be used', 'Appears at type level but not runtime', 'Causes runtime errors', 'Is always inferred'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Reduces a list to a single value', 'Applies a function to each element', 'Filters elements', 'Sorts elements'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Only global variables', 'Variables from enclosing scope', 'All program state', 'Only parameters'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['f(a)(b)(c)', 'f([a,b,c])', 'f(a+b+c)', 'f(c,b,a)'],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ['Eager computation', 'Computing values only when needed', 'Sequential execution', 'Parallel execution'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['map operation', 'flatMap operation', 'filter operation', 'reduce operation'],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ['filter', 'flatMap/bind', 'reduce', 'zip'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Imperative', 'Declarative', 'Recursive', 'Logic'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Functional', 'Imperative', 'Logic', 'Declarative'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Static nominal typing', 'Structural typing', 'Gradual typing', 'Dependent typing'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Types are enforced at runtime', 'Generic types are removed after compilation', 'Types cannot be inferred', 'All types are dynamic'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Java', 'Python', 'ML/Haskell', 'JavaScript'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Machine code', 'Mathematical objects', 'Execution traces', 'Test cases'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Only at loop start', 'Only at loop end', 'Before and after each iteration', 'Only inside the loop body'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Exact program behavior', 'Sound over-approximation', 'Always terminates', 'Dynamic analysis'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Code, Environment, Kontinuation', 'Control, Environment, Kontinuation', 'Closure, Expression, Key', 'Compute, Evaluate, Keep'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Direct AST traversal', 'Native compilation', 'Virtual instructions', 'Text parsing'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Single references', 'Null pointers', 'Cyclic references', 'Strong references'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Reference counting', 'Tracing from roots', 'Manual deallocation', 'Static analysis'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['All objects live forever', 'Most objects die young', 'Old objects die first', 'Memory is unlimited'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['All runtime errors', 'Data races at compile time', 'Stack allocation', 'Function calls'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['At least once', 'At most once', 'Exactly once', 'Never'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Only called', 'Passed as arguments and returned', 'Only defined at top level', 'Only recursive'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Instance creation', 'Class creation', 'Module import', 'Function calls'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Being faster', 'Supporting multiple entry/exit points', 'Using less memory', 'Being simpler'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Data and functions', 'Effect definition and handling', 'Types and values', 'Static and dynamic'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Only the first argument', 'Only the return type', 'All argument types', 'Only the receiver'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Data structures', 'Control flow to explicit continuations', 'Types to values', 'Static to dynamic'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Modifies objects in place', 'Copies live objects to new space', 'Uses reference counting', 'Never moves objects'],
        correctAnswer: 1,
