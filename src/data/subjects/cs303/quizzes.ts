...
export const cs303Quizzes: Quiz[] = [
    ...
    questions: [
      {
        ...
        options: ['Imperative programming', 'Functional programming', 'Object-oriented programming', 'Logic programming'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Pattern matching', 'Explicit control flow through statements', 'Logical inference', 'Message passing between objects'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Functional programming', 'Imperative programming', 'Logic programming', 'Event-driven programming'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Declarative uses more memory', 'Declarative describes what to compute, not how', 'Declarative is always faster', 'Declarative requires compilation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Encapsulation', 'Inheritance', 'Polymorphism', 'Unification'],
        correctAnswer: 3,
    ...
    questions: [
      {
        ...
        options: ['Shared memory with locks', 'Actor model', 'Thread pool', 'Busy waiting'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Mutexes', 'Channels', 'Semaphores', 'Barriers'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A language that only supports OOP', 'A language supporting multiple programming styles', 'A language with multiple compilers', 'A language for multi-core processors'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Combining multiple programs', 'Pattern matching that can bind variables', 'Merging databases', 'Compiling code'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Memory leaks', 'Race conditions and deadlocks', 'Stack overflow', 'Type errors'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Object-oriented', 'Functional', 'Logic programming', 'Imperative'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Being able to see through objects', 'An expression can be replaced by its value', 'Code that references other code', 'Transparent error handling'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['No inheritance', 'Objects inherit directly from other objects', 'No encapsulation', 'Static typing'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A way to close files', 'A function with its captured environment', 'The end of a program', 'A type of loop'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['To make code run faster', 'To prevent certain kinds of errors', 'To reduce code size', 'To improve readability only'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['At runtime', 'At compile time', 'At linking time', 'Never'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Guessing types at runtime', 'Automatic deduction of types by the compiler', 'Converting between types', 'Defining new types'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Types are checked at compile time', 'Implicit type conversions are restricted', 'Variables must have types', 'Types cannot change'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Multiple inheritance', 'Functions that work on multiple types uniformly', 'Method overloading', 'Type casting'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A type for mathematical operations', 'A composite type formed by sum and product types', 'A numeric type', 'A type alias'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['No type inference', 'Complete and decidable type inference', 'Only supporting integers', 'Manual type annotations required'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Types that are smaller in memory', 'A subtype can be used where a supertype is expected', 'Creating subtypes dynamically', 'Type parameters'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Types that depend on runtime', 'Types that can depend on values', 'Types with dependencies', 'Circular type definitions'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Fast compilation', 'Well-typed programs don\'t get stuck', 'Optimal performance', 'No memory leaks'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Speed and correctness', 'Progress and preservation', 'Soundness and completeness', 'Safety and liveness'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Random polymorphism', 'Polymorphism through overloading or type classes', 'Temporary polymorphism', 'Polymorphism without types'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A type that doesn\'t exist', 'A type parameter not used in the data structure but provides compile-time information', 'A deleted type', 'A runtime-only type'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Memory management', 'Null pointer exceptions', 'Concurrency', 'Performance'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['A function without bugs', 'A function that always returns the same output for the same input and has no side effects', 'A function with no parameters', 'A function that never fails'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Cannot be moved', 'Data cannot be changed after creation', 'Cannot be deleted', 'Cannot be copied'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A function in a higher directory', 'A function that takes functions as arguments or returns functions', 'A more important function', 'A recursive function'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Creates a geographic map', 'Applies a function to each element of a collection', 'Maps keys to values', 'Reduces a collection'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Writing functions', 'Combining functions so output of one becomes input of another', 'Decomposing functions', 'Function documentation'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Recursion at the end of a list', 'Recursion where the recursive call is the last operation', 'Recursion without a base case', 'Infinite recursion'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Folding paper', 'Combining collection elements into a single value using a function', 'Reducing code size', 'Compressing data'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Removing variables', 'Substituting arguments into function bodies', 'Reducing complexity', 'Beta testing'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Slow evaluation', 'Delaying evaluation until the result is needed', 'Incomplete evaluation', 'Parallel evaluation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A sound effect', 'A suspended computation awaiting evaluation', 'A type of error', 'A memory block'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['A type of function', 'A type that can be mapped over', 'A function factory', 'A debugging tool'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['map and filter', 'return/unit and bind/flatMap', 'get and set', 'read and write'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Memory management', 'Sequencing side effects in a pure language', 'Parallel I/O', 'File compression'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['No difference', 'foldl processes left-to-right, foldr right-to-left', 'foldl is faster', 'foldr is safer'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A functor for applications', 'A functor that allows applying wrapped functions to wrapped values', 'A special kind of monad', 'A debugging functor'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['To make code look formal', 'To give precise mathematical meaning to programs', 'To improve performance', 'To simplify syntax'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Operations on data', 'How programs execute step by step', 'Operator precedence', 'Operating system behavior'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Size of programs', 'Big-step evaluates to final value; small-step shows individual steps', 'Memory usage', 'Compilation speed'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Denotes variable names', 'Maps programs to mathematical objects (denotations)', 'Describes program names', 'Defines notation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A website for semantics', 'The set of possible meanings for a language construct', 'A domain name', 'A type of variable'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Logic puzzles', 'Reasoning about program correctness with pre/postconditions', 'Boolean logic', 'Hardware design'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Program', 'Precondition', 'Postcondition', 'Procedure'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A loop that never changes', 'An assertion true before and after each loop iteration', 'A constant in a loop', 'An infinite loop'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Partially working code', 'If the program terminates, it satisfies the specification', 'Some tests pass', 'Incomplete implementation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Performance', 'Termination', 'Documentation', 'Testing'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Art interpretation', 'Analyzing programs using approximations of their semantics', 'Interpreting bytecode', 'Abstract art programming'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Finding bugs', 'Finding the minimal precondition that ensures a postcondition', 'Weak typing', 'Performance optimization'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A constant value', 'A value x where f(x) = x, used to define recursion', 'A point in memory', 'The end of a program'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['It makes sound', 'If it reports no errors, the program is error-free', 'It runs quietly', 'It\'s well-documented'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['All code is analyzed', 'If the program is error-free, no errors are reported', 'The analysis finishes', 'Full test coverage'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Speed', 'An interpreter executes code directly; a compiler translates to another language', 'Memory usage', 'Language support'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A tree in abstract art', 'A tree structure representing the syntactic structure of code', 'A database tree', 'A file system tree'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Scoping for words', 'Variable scope determined by program text structure', 'Dictionary-based scoping', 'Runtime scoping'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Scoping that changes', 'Variable scope determined by the runtime call stack', 'Fast scoping', 'Type-based scoping'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['The operating system', 'A mapping from variable names to values', 'Hardware settings', 'External libraries'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Calling by phone', 'Arguments are evaluated before being passed to functions', 'Passing values directly', 'Value-based programming'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Using references', 'Arguments share memory location with parameters', 'Referencing documentation', 'Calling by name'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Using string names', 'Arguments are substituted unevaluated, evaluated when used', 'Named parameters', 'Nominal typing'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['On-demand calling', 'Like call-by-name but caches results after first evaluation', 'Need-based allocation', 'Lazy calling'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Closing files', 'Capturing the environment where a function is defined', 'Ending programs', 'Closing connections'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['A sequel', 'A representation of the rest of the computation', 'A continuation statement', 'A loop construct'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A coding standard', 'A style where functions receive an explicit continuation argument', 'Continuous processing system', 'A design pattern'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A circular dependency', 'An interpreter for a language written in that same language', 'A looping evaluator', 'Recursive evaluation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Removes functions', 'Converts higher-order programs to first-order by representing functions as data', 'Debugging functions', 'Function optimization'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A testing cycle', 'The fundamental interpreter loop: evaluate expressions, apply functions', 'An IDE feature', 'A compilation phase'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['All variables', 'Function call frames and local variables', 'Global data', 'Objects'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Only strings', 'Dynamically allocated objects with varying lifetimes', 'Function code', 'Constants'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Physical damage', 'Allocated memory that is no longer accessible but not freed', 'Data loss', 'Buffer overflow'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['An unused pointer', 'A pointer to memory that has been freed', 'A null pointer', 'A pointer arithmetic error'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A programming language', 'Tying resource lifetime to object lifetime', 'A memory allocator', 'An initialization pattern'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Deleting files', 'Automatically reclaiming unreachable memory', 'Compressing data', 'Defragmenting disk'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Marks files for deletion', 'Marks reachable objects, sweeps (frees) unmarked objects', 'Marks errors', 'Sweeps the stack'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Too slow', 'Cannot reclaim circular references', 'Uses too much memory', 'Only works for integers'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Code generations', 'The hypothesis that most objects die young', 'Generation gaps', 'Old programming styles'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['The main function', 'A starting point for reachability tracing', 'Root directory', 'The heap start'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Copyright management', 'Each value has one owner; ownership can be moved or borrowed', 'File ownership', 'Thread ownership'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A library checker', 'A compiler component that enforces borrowing rules', 'A runtime check', 'A linter'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Geographic allocation', 'Allocating objects in regions that are freed together', 'Regional programming', 'Disk regions'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Linear algebra', 'Ensuring values are used exactly once', 'Line-by-line processing', 'Linear search'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Preventing writes', 'Code executed on pointer writes to maintain GC invariants', 'A memory protection', 'A lock'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Programming metadata', 'Writing programs that manipulate programs', 'Programming about programming', 'Documentation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Large programs', 'Code transformations that happen before or during compilation', 'Keyboard shortcuts', 'Function aliases'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Code comments', 'A program examining and modifying its own structure at runtime', 'Error reflection', 'Code review'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Cleanliness', 'Hygienic macros avoid accidental variable capture', 'Documentation style', 'Performance'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Writing code', 'Automatically producing source code from specifications or models', 'Version control', 'Compilation'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Generic code', 'Parameterizing types over other types', 'Base classes', 'Default implementations'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Deleting types', 'Removing generic type information after compilation', 'Type errors', 'Type conversion'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['String matching', 'Checking data against patterns and binding variables', 'Regex', 'Image recognition'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Performance testing', 'Verifying all possible cases are handled', 'Testing thoroughly', 'Checking for loops'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Using templates', 'Performing computations at compile time using templates', 'Template design', 'Generic programming'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Visual effects', 'A type system extension tracking computational effects', 'Sound effects', 'Side effect removal'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Cooperative routines', 'Functions that can suspend and resume their execution', 'Helper functions', 'Library functions'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Hardware DSL', 'A domain-specific language implemented within a host language', 'Embedded systems language', 'A small DSL'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Asynchronous loading', 'Simplifying asynchronous code to look synchronous', 'Waiting for input', 'Async testing'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Tracking changes', 'Enabling language evolution while maintaining compatibility', 'Version control', 'Documentation'],
        correctAnswer: 1,
