...
export const cs405Exams: Exam[] = [
  {
    ...
    questions: [
      // === Cloud Fundamentals (10 questions) ===
      {
        id: 'mid-q1',
      ...
      },
      {
        ...
        options: ['5-10%', '10-30%', '30-75%', '80-90%'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['VMware ESXi', 'Xen', 'KVM', 'Hyper-V'],
        correctAnswer: 2,
      ...
      // === Containers and Docker (10 questions) ===
      {
        id: 'mid-q21',
        type: 'multiple_choice',
  ...
  },
  {
    ...
    questions: [
      // Cloud Fundamentals (5 questions)
      {
        id: 'final-q1',
        type: 'multiple_choice',
