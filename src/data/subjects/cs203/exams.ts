...
export const cs203Exams: Exam[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['DFA to NFA', 'NFA to DFA', 'DFA to PDA', 'NFA to regex'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Accept the empty string only', 'Change state without consuming input', 'Reject invalid inputs', 'Loop indefinitely'],
        correctAnswer: 1,
      ...
      },
      {
        id: 'cs203-mid-q7',
        type: 'multiple_choice',
        prompt: 'Regular languages are NOT closed under:',
        options: ['Union', 'Intersection', 'Complement', 'All of the above are closed'],
        correctAnswer: 3,
      ...
      },
      {
        ...
        options: ['All strings of even length', 'Strings with equal a\'s and b\'s', 'Strings containing "ab"', 'All strings over {a,b}'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Minimal DFA', 'NFA with ε-transitions', 'Parse tree', 'Context-free grammar'],
        correctAnswer: 1,
      ...
      // Context-Free Grammars
      {
        ...
        options: ['States and transitions', 'Variables, terminals, productions, start symbol', 'Stack and input tape', 'Regular expressions'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['It generates an infinite language', 'Some string has multiple parse trees', 'It has more than one production', 'It contains ε-productions'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A → aB | a', 'A → BC | a (plus S → ε if needed)', 'A → aBb', 'A → Ba'],
        correctAnswer: 1,
      ...
      // Pushdown Automata
      {
        ...
        options: ['Multiple tapes', 'A stack', 'Two-way head movement', 'An oracle'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Equivalent in power to NPDA', 'Strictly weaker than NPDA', 'Strictly stronger than NPDA', 'Equivalent to a Turing machine'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Not context-free', 'Context-free but not deterministic context-free', 'Deterministic context-free', 'Regular'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Incomparable in power', 'Equivalent in power', 'Final state is stronger', 'Empty stack is stronger'],
        correctAnswer: 1,
      ...
      // Mixed/Application Questions
      {
        ...
        options: ['Regular', 'Context-free but not regular', 'Not context-free', 'Decidable but not context-free'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Regular', 'Context-free', 'Context-sensitive but not context-free', 'Not context-sensitive'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Is the grammar ambiguous?', 'Does the grammar generate all strings?', 'Does the grammar generate the empty language?', 'Are two grammars equivalent?'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['xyz with y pumpable', 'uvxyz with v and y pumpable', 'uvwxy with v and x pumpable', 'abcde with b and d pumpable'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Closure under intersection', 'Closure under complement', 'Closure under union', 'All of the above'],
        correctAnswer: 2,
  ...
  },
  {
    ...
    questions: [
      // Turing Machines (Topic 5)
      {
        id: 'cs203-final-q1',
        type: 'multiple_choice',
        prompt: 'A Turing machine differs from a PDA primarily in having:',
        options: ['More states', 'A read/write tape with bidirectional head movement', 'Multiple stacks', 'Nondeterminism'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Solve the halting problem', 'Simulate any other Turing machine', 'Compute non-computable functions', 'Run faster than any specific TM'],
        correctAnswer: 1,
      ...
      // Decidability (Topic 6)
      {
        id: 'cs203-final-q7',
        type: 'multiple_choice',
        prompt: 'The halting problem is:',
        options: ['Decidable', 'Undecidable but recognizable', 'Not even recognizable', 'Decidable for some TMs'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['L is finite', 'L is context-free', 'Both L and L̄ are recognizable', 'L is regular'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['It is in NP', 'It is NP-hard', 'It is in NP and NP-hard', 'It is not in P'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['CLIQUE', 'HAMPATH', 'SAT', 'VERTEX-COVER'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['P = NP', 'NP = PSPACE', 'P ⊊ EXPTIME', 'L = P'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['SAT', 'TQBF (True Quantified Boolean Formulas)', 'CLIQUE', 'HAMPATH'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Only P', 'Only NL', 'Both NL and P', 'Neither NL nor P'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['P = NP', 'NL = coNL', 'PSPACE = NPSPACE', 'L = NL'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['P ≠ NP', 'NP ≠ PSPACE', 'L ≠ PSPACE', 'P ≠ PSPACE'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['In P', 'NP-complete', 'PSPACE-complete', 'Undecidable'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Regular languages', 'Context-free languages', 'Context-sensitive languages', 'All decidable languages'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['SAT', 'Primality testing', 'Graph coloring', 'Halting problem'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Polynomial', 'Exponential', 'Computable', 'Not computable'],
        correctAnswer: 3,
