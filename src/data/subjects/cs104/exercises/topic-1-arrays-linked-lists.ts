...
export const topic1Exercises: CodingExercise[] = [
  ...
  },
  {
    ...
    testCases: [],
    hints: ['Use two pointers: one for reading, one for writing non-zero values', 'Swap instead of overwrite to handle all cases'],
    language: 'python'
  },
  {
    id: 'cs104-t1-ex10',
    ...
    testCases: [],
    hints: ['Use two pointers with n nodes gap between them', 'Use a dummy node to handle edge case of removing head'],
    language: 'python'
  },
  {
    id: 'cs104-t1-ex11',
    ...
    testCases: [],
    hints: ['If we traverse A+B and B+A, both paths have same length', 'They will meet at intersection or both reach None'],
    language: 'python'
  },
  {
    id: 'cs104-t1-ex12',
  ...
  },
  {
    ...
    testCases: [],
    hints: ['Find the middle using slow/fast pointers', 'Reverse the second half', 'Compare first half with reversed second half'],
    language: 'python'
  },
  {
    id: 'cs104-t1-ex14',
    ...
    testCases: [],
    hints: ['Treat array values as "next pointers" - nums[i] points to index nums[i]', 'A duplicate means two indices point to same location = cycle', 'Use Floyd\'s cycle detection to find the duplicate'],
    language: 'python'
  },
  {
    id: 'cs104-t1-ex15',
    ...
    testCases: [],
    hints: ['Find the middle of the list', 'Reverse the second half', 'Merge the two halves by alternating nodes'],
    language: 'python'
  },
  {
    id: 'cs104-t1-ex16',
    ...
    testCases: [],
    hints: ['Double capacity when array is full', 'Halve capacity when 1/4 full (to avoid thrashing)', 'Amortized O(1) for append operations'],
    language: 'python'
  }
];
