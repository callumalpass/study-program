...
export const topic5Exercises: CodingExercise[] = [
  ...
  },
  {
    ...
    testCases: [],
    hints: ['Think backwards: find cells reachable FROM the oceans', 'DFS from ocean borders going uphill', 'Answer is intersection of cells reaching both oceans'],
    language: 'python'
  },
  {
    id: 'cs104-t5-ex10',
    ...
    testCases: [],
    hints: ['Model as graph: words are nodes, edges connect words differing by one letter', 'Use BFS for shortest path', 'Use wildcard patterns for efficient neighbor finding'],
    language: 'python'
  },
  {
    id: 'cs104-t5-ex11',
    ...
    testCases: [],
    hints: ['Start from border Os - these cannot be captured', 'Mark all Os connected to border with temporary marker', 'Then flip: remaining Os to X, temporary back to O'],
    language: 'python'
  },
  {
    id: 'cs104-t5-ex12',
    ...
    testCases: [],
    hints: ['A tree with n nodes has exactly n-1 edges', 'If n-1 edges and all nodes connected, no cycles possible', 'Check connectivity with DFS from any node'],
    language: 'python'
  },
  {
    id: 'cs104-t5-ex13',
    ...
    testCases: [],
    hints: ['Modified Bellman-Ford: relax exactly k+1 times', 'Use temp array to prevent using edges from same round', 'Each iteration allows one more edge/stop'],
    language: 'python'
  },
  {
    id: 'cs104-t5-ex14',
    ...
    testCases: [],
    hints: ['Use Union-Find data structure', 'If an edge connects already-connected nodes, it creates cycle', 'Return the first edge that creates a cycle'],
    language: 'python'
  },
  {
    id: 'cs104-t5-ex15',
    ...
    testCases: [],
    hints: ['Multi-source BFS: start from all rotten oranges', 'Process level by level (each level = 1 minute)', 'Track fresh count; return -1 if any remain'],
    language: 'python'
  },
  {
    id: 'cs104-t5-ex16',
    ...
    testCases: [],
    hints: ['Use DFS with backtracking', 'No need to track visited in DAG (no cycles)', 'Copy path when reaching target'],
    language: 'python'
  }
];
