...
export const topic4Exercises: CodingExercise[] = [
  // EXISTING exercise - preserve ID
  {
    ...
    testCases: [
      { input: '"leetcode"', expectedOutput: '0', isHidden: false, description: 'First character is unique' },
      { input: '"loveleetcode"', expectedOutput: '2', isHidden: false, description: 'Third character is first unique' },
      { input: '"aabb"', expectedOutput: '-1', isHidden: true, description: 'No unique characters' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '[2, 7, 11, 15], target=9', expectedOutput: '[0, 1]', isHidden: false, description: '2 + 7 = 9' },
      { input: '[3, 2, 4], target=6', expectedOutput: '[1, 2]', isHidden: true, description: '2 + 4 = 6' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '["eat","tea","tan","ate","nat","bat"]', expectedOutput: '[["eat","tea","ate"],["tan","nat"],["bat"]]', isHidden: false, description: 'Group anagrams' },
  ...
  },
  {
    ...
    testCases: [
      { input: 'hm.put("a", 1); hm.get("a")', expectedOutput: '1', isHidden: false, description: 'Get after put' },
      { input: 'hm.put("a", 1); hm.remove("a"); hm.get("a")', expectedOutput: 'None', isHidden: true, description: 'Get after remove' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '[1, 1, 1], k=2', expectedOutput: '2', isHidden: false, description: 'Two subarrays sum to 2' },
      { input: '[1, 2, 3], k=3', expectedOutput: '2', isHidden: true, description: '[1,2] and [3]' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '[100, 4, 200, 1, 3, 2]', expectedOutput: '4', isHidden: false, description: 'Sequence 1,2,3,4' },
      { input: '[0, 3, 7, 2, 5, 8, 4, 6, 0, 1]', expectedOutput: '9', isHidden: true, description: 'Sequence 0-8' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '[1, 2, 3, 1], k=3', expectedOutput: 'True', isHidden: false, description: 'Duplicate within k' },
      { input: '[1, 2, 3, 1, 2, 3], k=2', expectedOutput: 'False', isHidden: true, description: 'Duplicate too far' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: 'post(1,5); post(1,3); getNewsFeed(1)', expectedOutput: '[3, 5]', isHidden: false, description: 'Own tweets' },
      { input: 'post(1,5); follow(2,1); getNewsFeed(2)', expectedOutput: '[5]', isHidden: true, description: 'Followed tweets' }
    ],
