...
export const topic4Exercises: CodingExercise[] = [
  ...
  },
  {
    ...
    testCases: [],
    hints: ['Count character frequencies in first string', 'Decrement counts while iterating second string', 'Early return if character missing or count goes negative'],
    language: 'python'
  },
  {
    id: 'cs104-t4-ex10',
    ...
    testCases: [],
    hints: ['Need bidirectional mapping: s->t and t->s', 'Check consistency in both directions', 'No character can map to two different characters'],
    language: 'python'
  },
  {
    id: 'cs104-t4-ex11',
    ...
    testCases: [],
    hints: ['Similar to isomorphic strings', 'Map pattern characters to words bidirectionally', 'Split string into words first'],
    language: 'python'
  },
  {
    id: 'cs104-t4-ex12',
    ...
    testCases: [],
    hints: ['Use array itself as hash table', 'Mark visited by negating value at index nums[i]-1', 'If already negative, we found a duplicate'],
    language: 'python'
  },
  {
    id: 'cs104-t4-ex13',
    ...
    testCases: [],
    hints: ['First count frequencies with hash map', 'Use bucket sort by frequency for O(n)', 'Alternative: use heap for O(n log k)'],
    language: 'python'
  },
  {
    id: 'cs104-t4-ex14',
    ...
    testCases: [],
    hints: ['Use sliding window with two pointers', 'Expand right to include all chars, contract left to minimize', 'Track how many required chars are satisfied'],
    language: 'python'
  },
  {
    id: 'cs104-t4-ex15',
    ...
    testCases: [],
    hints: ['Use hash map for O(1) lookup + array for O(1) random access', 'To remove, swap element with last and pop', 'Update hash map when swapping'],
    language: 'python'
  },
  {
    id: 'cs104-t4-ex16',
    ...
    testCases: [],
    hints: ['Track frequency per key and keys per frequency', 'Use OrderedDict for LRU among same frequency', 'Track min_freq for O(1) eviction'],
    language: 'python'
  }
];
