...
export const topic2Exercises: CodingExercise[] = [
  {
    ...
    testCases: [
      { input: '"00:1A:2B:3C:4D:5E"', isHidden: false, description: 'Valid MAC with colons' },
      { input: '"00-1A-2B-3C-4D-5E"', isHidden: false, description: 'Valid MAC with dashes' },
      { input: '"invalid"', isHidden: true, description: 'Invalid format' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '"00-1a-2b-3c-4d-5e"', isHidden: false, description: 'MAC with dashes' },
      { input: '"001a2b3c4d5e"', isHidden: false, description: 'MAC without separators' },
      { input: '"FF:ff:FF:ff:FF:ff"', isHidden: true, description: 'Mixed case MAC' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '"00:50:56:12:34:56"', isHidden: false, description: 'VMware MAC' },
      { input: '"00-0C-29-AB-CD-EF"', isHidden: false, description: 'VMware with dashes' },
      { input: '"FF:FF:FF:FF:FF:FF"', isHidden: true, description: 'Unknown vendor' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'add: "1010101"', isHidden: false, description: 'Add parity to odd count' },
      { input: 'verify: "10101010"', isHidden: false, description: 'Verify even parity' },
      { input: 'verify: "10101011"', isHidden: true, description: 'Verify with error' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '"1101011011", "10011"', isHidden: false, description: 'CRC-4 example' },
      { input: '"11010110", "1011"', isHidden: true, description: 'CRC-3 example' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '"1011101", "1001001"', isHidden: false, description: 'Two bit difference' },
      { input: '"00000", "11111"', isHidden: false, description: 'All different' },
      { input: '"1010", "1010"', isHidden: true, description: 'Identical strings' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '"AA:BB:CC:DD:EE:FF", "11:22:33:44:55:66", "Hello"', isHidden: false, description: 'Basic frame' },
      { input: '"00:00:00:00:00:01", "FF:FF:FF:FF:FF:FF", "Data"', isHidden: true, description: 'Broadcast frame' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'max_attempts=16, seed=42', isHidden: false, description: 'Default parameters' },
      { input: 'max_attempts=5, seed=123', isHidden: true, description: 'Limited attempts' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'add and lookup', isHidden: false, description: 'Basic operations' },
      { input: 'expiry test', isHidden: true, description: 'TTL expiration' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '"81000064"', isHidden: false, description: 'VLAN 100' },
      { input: '"8100A001"', isHidden: false, description: 'Priority 5, VLAN 1' },
      { input: '"81002000"', isHidden: true, description: 'DEI set' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '[0x01, 0x7E, 0x02, 0x7D, 0x03]', isHidden: false, description: 'Data with special bytes' },
      { input: '[0x01, 0x02, 0x03]', isHidden: false, description: 'Normal data' },
      { input: '[0x7E, 0x7E]', isHidden: true, description: 'Consecutive flags' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'window_size=4', isHidden: false, description: 'Window of 4' },
      { input: 'fill window and ack', isHidden: true, description: 'Full window cycle' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '[0x00, 0x01, 0x00, 0x02, 0x00, 0x03]', isHidden: false, description: 'Simple data' },
      { input: '[0xFF, 0xFF, 0xFF, 0xFF]', isHidden: true, description: 'Max values' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'unknown dst', isHidden: false, description: 'Flood on unknown' },
      { input: 'known dst', isHidden: false, description: 'Forward to known' },
      { input: 'same port', isHidden: true, description: 'No forward to same port' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'matrix with error', isHidden: false, description: 'Detect error position' },
      { input: 'clean matrix', isHidden: true, description: 'No error present' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'different priorities', isHidden: false, description: 'Priority-based election' },
      { input: 'same priority', isHidden: true, description: 'Bridge ID tiebreaker' }
    ],
    hints: [
