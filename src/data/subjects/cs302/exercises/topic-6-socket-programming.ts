...
export const topic6Exercises: CodingExercise[] = [
  {
    ...
    testCases: [
      { input: '"192.168.1.1:8080"', isHidden: false, description: 'Standard format' },
      { input: '"127.0.0.1:80"', isHidden: false, description: 'Localhost' },
      { input: '"10.0.0.1:443"', isHidden: true, description: 'HTTPS port' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '"file_transfer"', isHidden: false, description: 'TCP for files' },
      { input: '"video_streaming"', isHidden: false, description: 'UDP for video' },
      { input: '"dns_query"', isHidden: true, description: 'UDP for DNS' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'initial state', isHidden: false, description: 'CLOSED' },
      { input: 'after connect', isHidden: false, description: 'ESTABLISHED' },
      { input: 'send when closed', isHidden: true, description: 'Error' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'frame "Hello"', isHidden: false, description: 'Add length prefix' },
      { input: 'unframe multiple', isHidden: true, description: 'Extract messages' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'recv with data', isHidden: false, description: 'Returns data' },
      { input: 'recv empty buffer', isHidden: true, description: 'Raises WouldBlock' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'send data', isHidden: false, description: 'Echo back' },
      { input: 'unknown client', isHidden: true, description: 'Return None' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'messages from one source', isHidden: false, description: 'Grouped by source' },
      { input: 'get all sources', isHidden: true, description: 'List sources' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'acquire two connections', isHidden: false, description: 'Track in use' },
      { input: 'release and reacquire', isHidden: true, description: 'Connection reuse' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'select ready sockets', isHidden: false, description: 'Returns ready sockets' },
      { input: 'no ready sockets', isHidden: true, description: 'Empty lists' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'queue and get send data', isHidden: false, description: 'Partial read' },
      { input: 'buffer full', isHidden: true, description: 'Respect limits' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'forward lookup', isHidden: false, description: 'Hostname to IP' },
      { input: 'reverse lookup', isHidden: true, description: 'IP to hostname' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'complete messages', isHidden: false, description: 'Parse two messages' },
      { input: 'partial message', isHidden: true, description: 'Buffer incomplete' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'get remaining time', isHidden: false, description: 'Time before timeout' },
      { input: 'check timeout', isHidden: true, description: 'After timeout' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'within limit', isHidden: false, description: 'Connections allowed' },
      { input: 'exceed limit', isHidden: false, description: 'Connection denied' },
      { input: 'after window', isHidden: true, description: 'Old connections expire' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'build protocol message', isHidden: false, description: 'Binary format' },
      { input: 'string encoding', isHidden: true, description: 'Length-prefixed' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: 'track connections', isHidden: false, description: 'Update activity' },
      { input: 'identify idle', isHidden: true, description: 'Timeout detection' }
    ],
    hints: [
