...
export const cs103Exams: Exam[] = [
  {
    ...
    questions: [
      // === Classes & Objects (7) ===
      {
        ...
        options: ['A blueprint for creating data', 'An instance of a class with its own state', 'A Python module', 'A function with parameters'],
        correctAnswer: 1,
...
print(C())`,
      ...
      },
      {
        ...
        options: ['Truly private, inaccessible', 'Internal/protected by convention', 'Constant value', 'Static variable'],
        correctAnswer: 1,
...
print(b.items)`,
      ...
      },
      {
        ...
        modelAnswer:
          'Returning a defensive copy (e.g., `list(self._items)` or `dict(self._data)`) prevents external code from modifying a class’s internal mutable state without going through the class’s API. This helps maintain invariants, makes bugs less likely, and allows internal representations to change without breaking callers.',
      },
      ...
      // === Inheritance & Polymorphism (9) ===
      {
        ...
        options: ['Has-a', 'Is-a', 'Depends-on', 'Contained-in'],
        correctAnswer: 1,
...
print(D().f())`,
      ...
      },
      {
        ...
        options: ['Method Runtime Override', 'Memory Read Only', 'Method Resolution Order', 'Multiple Return Output'],
        correctAnswer: 2,
...
chorus([Dog(), Cat()])`,
      ...
      },
      {
        ...
        type: 'coding',
        prompt:
          'Implement a class `Temperature` with a property `celsius` that rejects values below -273.15 (raise ValueError).',
        starterCode:
          'class Temperature:\n' +
        ...
        solution:
          ...
          '        self._celsius = value\n',
        testCases: [
          { input: 't = Temperature(0)\nprint(t.celsius)', isHidden: false, description: 'Stores 0' },
          { input: 't = Temperature(1); t.celsius = 10; print(t.celsius)', isHidden: false, description: 'Setter updates' },
          {
            input: 'try:\n    Temperature(-300)\n    print("no")\nexcept ValueError:\n    print("yes")',
            isHidden: true,
      ...
      },
      {
        ...
        type: 'coding',
        prompt:
          'Implement a class `Vector2D(x, y)` with `__add__` (vector addition) and `__repr__` returning `Vector2D(x, y)`.',
        starterCode:
          'class Vector2D:\n' +
        ...
        testCases: [
          ...
          { input: 'v = Vector2D(-1,5) + Vector2D(1,-2)\nprint(v)', isHidden: false, description: 'Handles negatives' },
...
print(g(B()))`,
      ...
      },
      {
        ...
        modelAnswer:
          '“Is-a” describes inheritance/subtyping: a `Dog` is an `Animal`, so `Dog(Animal)` can override/extend behavior. “Has-a” describes composition: a `Car` has an `Engine`, so the `Car` stores an `Engine` instance and delegates to it. Inheritance models specialization; composition models collaboration/containment.',
      },
      ...
      // === Design Patterns (12) ===
      {
        ...
        options: ['Observer', 'Factory', 'Decorator', 'Adapter'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Decorator', 'Singleton', 'Factory', 'Template Method'],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ['Observer', 'Factory', 'Adapter', 'Facade'],
        correctAnswer: 0,
...
print(LoggingDecorator(Service()).run())`,
      ...
      },
      {
        ...
        options: ['Facade', 'Observer', 'Decorator', 'Strategy'],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ['God Object', 'Strategy', 'Adapter', 'Factory'],
        correctAnswer: 0,
      ...
      // === Abstraction & Interfaces (8) ===
      {
        ...
        options: ['It guarantees faster runtime', 'It reduces coupling and makes implementations swappable', 'It removes the need for tests', 'It forbids inheritance'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['typing', 'abc', 'dataclasses', 'inspect'],
        correctAnswer: 1,
...
A()`,
      ...
      },
      {
        ...
        options: ['They reduce memory use', 'They force implementations to include irrelevant methods', 'They prevent polymorphism', 'They improve cohesion'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        modelAnswer:
          'Small, focused interfaces improve cohesion and reduce coupling. Implementers only need to support relevant operations (fewer meaningless stubs), and consumers depend on fewer methods, so changes are less likely to break code. This also makes testing simpler and enables better substitution and composition.',
      },
      {
        id: 'final-q29',
        type: 'fill_blank',
      ...
      // === Coding (12) ===
      {
        ...
        type: 'coding',
        prompt:
          'Write a class `EventBus` with `subscribe(fn)`, `unsubscribe(fn)`, and `publish(message)` that notifies all subscribers.',
        starterCode:
          'class EventBus:\n' +
          '    def __init__(self):\n' +
          '        # TODO\n' +
        ...
        testCases: [
          ...
          { input: 'bus = EventBus(); bus.publish("x"); print("ok")', isHidden: true, description: 'No subscribers ok' },
        ],
        correctAnswer: true,
      ...
      },
      {
        ...
        type: 'coding',
        prompt:
          'Write a class `Validator` that takes a list of rules (objects with `check(text) -> bool`) and returns True only if all rules pass.',
        starterCode:
          'class Validator:\n' +
        ...
        testCases: [
          { input: 'class MinLen:\n    def __init__(self, n): self.n=n\n    def check(self, t): return len(t)>=self.n\n\nv = Validator([MinLen(3)])\nprint(v.is_valid("abc"), v.is_valid("ab"))', isHidden: false, description: 'Single rule' },
          {
            input:
          ...
          { input: 'v = Validator([])\nprint(v.is_valid("anything"))', isHidden: true, description: 'No rules => True' },
        ],
        correctAnswer: true,
      ...
      },
      {
        ...
        options: ['It makes code shorter', 'It allows replacing dependencies with fakes/stubs', 'It prevents exceptions', 'It enforces inheritance'],
        correctAnswer: 1,
...
print(c.n)`,
      ...
      },
      {
        ...
        options: ['Code duplication and hard-to-test design', 'The program runs fast', 'The code has many comments', 'The file is short'],
        correctAnswer: 0,
...
print(a.x)`,
      ...
      },
      {
        ...
        options: ['Observer', 'Strategy', 'Singleton', 'Builder'],
        correctAnswer: 1,
