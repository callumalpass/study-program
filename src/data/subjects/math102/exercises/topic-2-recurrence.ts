...
export const topic2Exercises: CodingExercise[] = [
  // EXISTING exercise - preserve ID
  {
    ...
    testCases: [
      { input: '10', isHidden: false, description: 'F(10) = 55' },
      { input: '0', isHidden: false, description: 'F(0) = 0' },
      { input: '20', isHidden: true, description: 'F(20) = 6765' },
      { input: '1', isHidden: true, description: 'F(1) = 1' }
    ],
    hints: [
  ...
  },
  {
    ...
    testCases: [
      { input: '10', isHidden: false, description: 'F(10) = 55' },
      { input: '1', isHidden: false, description: 'F(1) = 1' },
      { input: '30', isHidden: true, description: 'F(30) = 832040' },
      { input: '0', isHidden: true, description: 'F(0) = 0' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '4', isHidden: false, description: '2^4 - 1 = 15' },
      { input: '3', isHidden: false, description: '2^3 - 1 = 7' },
      { input: '10', isHidden: true, description: '2^10 - 1 = 1023' },
      { input: '1', isHidden: true, description: '2^1 - 1 = 1' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '5', isHidden: false, description: '8 ways to climb 5 stairs' },
      { input: '3', isHidden: false, description: '3 ways to climb 3 stairs' },
      { input: '10', isHidden: true, description: '89 ways to climb 10 stairs' },
      { input: '1', isHidden: true, description: '1 way to climb 1 stair' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '1, 1, 0, 1, 10', isHidden: false, description: 'Fibonacci F(10) = 55' },
      { input: '2, 1, 1, 2, 5', isHidden: false, description: 'Custom recurrence' },
      { input: '1, 1, 0, 1, 20', isHidden: true, description: 'Fibonacci F(20)' },
      { input: '3, 2, 1, 1, 6', isHidden: true, description: 'Another recurrence' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '2, 2, 1', isHidden: false, description: 'Merge sort: O(n log n)' },
      { input: '4, 2, 2', isHidden: false, description: 'Case 2: O(n² log n)' },
      { input: '8, 2, 2', isHidden: true, description: 'Case 1: O(n³)' },
      { input: '2, 2, 0', isHidden: true, description: 'Binary search: O(log n)' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '[1, 5, 10, 25], 37', isHidden: false, description: '37 cents: 4 coins' },
      { input: '[1, 2, 5], 11', isHidden: false, description: '11: 3 coins' },
      { input: '[2], 3', isHidden: true, description: 'Impossible: -1' },
      { input: '[1, 5, 10], 27', isHidden: true, description: '27 cents' }
    ],
  ...
  },
  {
    ...
    testCases: [
      { input: '50', isHidden: false, description: 'F(50) large value' },
      { input: '10', isHidden: false, description: 'F(10) = 55' },
      { input: '100', isHidden: true, description: 'F(100) very large' },
      { input: '0', isHidden: true, description: 'F(0) = 0' }
    ],
    hints: ['Matrix [[1,1],[1,0]]^n gives Fibonacci', 'Use binary exponentiation for O(log n)'],
    language: 'python'
  },
  {
    id: 'math102-t2-ex10',
    ...
    testCases: [
      { input: '20', isHidden: false, description: 'F(20) = 6765' },
      { input: '10', isHidden: false, description: 'F(10) = 55' },
      { input: '30', isHidden: true, description: 'F(30) = 832040' },
      { input: '1', isHidden: true, description: 'F(1) = 1' }
    ],
    hints: ['phi = (1 + sqrt(5)) / 2 (golden ratio)', 'Formula: (phi^n - psi^n) / sqrt(5)'],
    language: 'python'
  },
  {
    id: 'math102-t2-ex11',
    ...
    testCases: [
      { input: '10', isHidden: false, description: 'T(10) = 149' },
      { input: '5', isHidden: false, description: 'T(5) = 7' },
      { input: '20', isHidden: true, description: 'T(20) = 66012' },
      { input: '0', isHidden: true, description: 'T(0) = 0' }
    ],
    hints: ['Track last three values', 'O(n) time, O(1) space'],
    language: 'python'
  },
  {
    id: 'math102-t2-ex12',
    ...
    testCases: [
      { input: '[10, 9, 2, 5, 3, 7, 101, 18]', isHidden: false, description: 'LIS = 4' },
      { input: '[0, 1, 0, 3, 2, 3]', isHidden: false, description: 'LIS = 4' },
      { input: '[7, 7, 7, 7]', isHidden: true, description: 'All same: LIS = 1' },
      { input: '[1, 2, 3, 4, 5]', isHidden: true, description: 'Sorted: LIS = 5' }
    ],
    hints: ['dp[i] = longest LIS ending at i', 'Check all previous elements'],
    language: 'python'
  },
  {
    id: 'math102-t2-ex13',
    ...
    testCases: [
      { input: '"kitten", "sitting"', isHidden: false, description: 'Distance = 3' },
      { input: '"abc", "abc"', isHidden: false, description: 'Same string: 0' },
      { input: '"", "test"', isHidden: true, description: 'Empty to test: 4' },
      { input: '"intention", "execution"', isHidden: true, description: 'Distance = 5' }
    ],
    hints: ['2D DP table', 'If chars match, no operation needed'],
    language: 'python'
  },
  {
    id: 'math102-t2-ex14',
    ...
    hints: ['Use coins approach with coins = [1,2,...,n]', 'Count ways, not minimum'],
    language: 'python'
  },
  {
    id: 'math102-t2-ex15',
    ...
    testCases: [
      { input: '[10, 20, 30, 40, 30]', isHidden: false, description: '4 matrices' },
      { input: '[10, 30, 5, 60]', isHidden: false, description: '3 matrices: 4500' },
      { input: '[40, 20, 30, 10, 30]', isHidden: true, description: '4 matrices' },
      { input: '[10, 20, 30]', isHidden: true, description: '2 matrices: 6000' }
    ],
    hints: ['Try all split points k between i and j', 'Cost: dims[i]*dims[k+1]*dims[j+1]'],
    language: 'python'
  },
  {
    id: 'math102-t2-ex16',
    ...
    testCases: [
      { input: '1024', isHidden: false, description: 'Analyze with n=1024' },
      { input: '256', isHidden: false, description: 'Analyze with n=256' },
      { input: '4096', isHidden: true, description: 'Larger input' },
      { input: '64', isHidden: true, description: 'Smaller input' }
    ],
    hints: ['a=3, b=4, so log_4(3) ≈ 0.79', 'f(n) = n*log(n) is Case 3 (f grows faster)'],
    language: 'python'
  }
];
