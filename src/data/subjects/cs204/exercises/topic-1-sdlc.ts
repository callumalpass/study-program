...
export const topic1Exercises: WrittenExercise[] = [
  {
    ...
    difficulty: 2,
    hints: ['Consider sequential nature', 'Think about requirements stability', 'Consider documentation needs'],
  ...
  },
  {
    ...
    difficulty: 2,
    hints: ['Focus on adaptability', 'Consider feedback cycles', 'Think about documentation levels'],
  ...
  },
  {
    ...
    difficulty: 3,
    hints: ['Consider risk-driven approach', 'Think about prototyping', 'Consider cost of iterations'],
  ...
  },
  {
    ...
    difficulty: 3,
    hints: ['Start with core features', 'Each increment delivers value', 'Build progressively'],
  ...
  },
  {
    ...
    difficulty: 2,
    hints: ['V-shape pairs phases', 'Left side: development', 'Right side: testing'],
  ...
  },
  {
    ...
    difficulty: 3,
    hints: ['Consider rapid prototyping', 'Think about user involvement', 'Consider project size'],
  ...
  },
  {
    ...
    difficulty: 2,
    hints: ['Consider collaboration', 'Think about automation', 'Consider shared responsibility'],
  ...
  },
  {
    ...
    difficulty: 4,
    hints: ['Consider requirements stability', 'Think about risk tolerance', 'Consider regulatory constraints'],
  ...
  },
  {
    ...
    difficulty: 3,
    hints: ['Consider productivity and quality', 'Think about leading indicators', 'Consider actionable metrics'],
  ...
  },
  {
    ...
    difficulty: 4,
    hints: ['Consider short-term vs long-term', 'Think about payback strategies', 'Consider tracking methods'],
  ...
  },
  {
    ...
    difficulty: 2,
    hints: ['Consider integration challenges', 'Think about feedback speed', 'Consider automation'],
  ...
  },
  {
    ...
    difficulty: 2,
    hints: ['Think about feedback incorporation', 'Consider risk reduction', 'Think about early delivery'],
  ...
  },
  {
    ...
    difficulty: 2,
    hints: ['Consider documentation artifacts', 'Think about stakeholder needs', 'Consider traceability'],
  ...
  },
  {
    ...
    difficulty: 4,
    hints: ['Consider cost of change', 'Think about flexibility', 'Consider timeline impact'],
  ...
  },
  {
    ...
    difficulty: 3,
    hints: ['Consider multiple factors', 'Think about project context', 'Consider team capabilities'],
  ...
  },
  {
    ...
    difficulty: 3,
    hints: ['Think about automation end-to-end', 'Consider consistency', 'Think about deployment frequency'],
