...
export const cs205Topic6Exercises: CodingExercise[] = [
  {
    id: 'cs205-ex-6-1',
    subjectId: 'cs205',
    topicId: 'cs205-6',
    ...
    testCases: [
      { input: 'index creation', expectedOutput: 'Index created on Email', isHidden: false, description: 'Basic index' }
    ],
    hints: ['Use CREATE INDEX syntax.', 'Name should indicate table and column.']
  },
  {
    id: 'cs205-ex-6-2',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'index creation', expectedOutput: 'Unique index created', isHidden: false, description: 'Unique index' }
    ],
    hints: ['UNIQUE prevents duplicate values.', 'Unique indexes enforce uniqueness constraint.']
  },
  {
    id: 'cs205-ex-6-3',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'index creation', expectedOutput: 'Composite index created', isHidden: false, description: 'Multi-column index' }
    ],
    hints: ['List columns in parentheses.', 'Column order matters for query patterns.']
  },
  {
    id: 'cs205-ex-6-4',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'index creation', expectedOutput: 'Covering index with INCLUDE', isHidden: false, description: 'Covering index' }
    ],
    hints: ['INCLUDE adds non-key columns.', 'Covering indexes avoid table lookups.']
  },
  {
    id: 'cs205-ex-6-5',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'index creation', expectedOutput: 'Partial index created', isHidden: false, description: 'Filtered index' }
    ],
    hints: ['WHERE clause filters indexed rows.', 'Smaller index = faster maintenance.']
  },
  {
    id: 'cs205-ex-6-6',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'drop', expectedOutput: 'Index dropped', isHidden: false, description: 'Drop index' }
    ],
    hints: ['DROP INDEX removes the index.', 'Some databases need table name: DROP INDEX idx ON table.']
  },
  {
    id: 'cs205-ex-6-7',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'index creation', expectedOutput: 'Expression index created', isHidden: false, description: 'Function-based index' }
    ],
    hints: ['Expression indexes store computed values.', 'Query must use same expression to use index.']
  },
  {
    id: 'cs205-ex-6-8',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'calculation', expectedOutput: '99 keys', isHidden: false, description: 'B-tree order' }
    ],
    hints: ['Keys = pointers - 1.', 'Keys separate child pointers.']
  },
  {
    id: 'cs205-ex-6-9',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'calculation', expectedOutput: 'Height ~3', isHidden: false, description: 'Tree height' }
    ],
    hints: ['Each level multiplies capacity by order.', 'Height = log_m(n) approximately.']
  },
  {
    id: 'cs205-ex-6-10',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'analysis', expectedOutput: 'Composite index identified', isHidden: false, description: 'Index selection' }
    ],
    hints: ['Equality columns before range/sort.', 'Match ORDER BY to avoid sorting.']
  },
  {
    id: 'cs205-ex-6-11',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'explanation', expectedOutput: 'Clear comparison', isHidden: false, description: 'Index types' }
    ],
    hints: ['Clustered = physical order.', 'Only one clustered per table.']
  },
  {
    id: 'cs205-ex-6-12',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'maintenance', expectedOutput: 'Index rebuilt', isHidden: false, description: 'Index rebuild' }
    ],
    hints: ['REBUILD recreates the index.', 'ONLINE = ON allows concurrent access.']
  },
  {
    id: 'cs205-ex-6-13',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'statistics', expectedOutput: 'Statistics updated', isHidden: false, description: 'Update stats' }
    ],
    hints: ['Statistics help optimizer choose plans.', 'Run after significant data changes.']
  },
  {
    id: 'cs205-ex-6-14',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'query', expectedOutput: 'Unused indexes listed', isHidden: false, description: 'Index analysis' }
    ],
    hints: ['pg_stat_user_indexes tracks usage.', 'idx_scan = 0 means never used.']
  },
  {
    id: 'cs205-ex-6-15',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'calculation', expectedOutput: 'Selectivity calculated', isHidden: false, description: 'Selectivity analysis' }
    ],
    hints: ['Selectivity = distinct/total.', 'Higher selectivity = better for indexing.']
  },
  {
    id: 'cs205-ex-6-16',
    subjectId: 'cs205',
    ...
    testCases: [
      { input: 'index creation', expectedOutput: 'Hash index created', isHidden: false, description: 'Hash index' }
    ],
    hints: ['USING HASH specifies hash index.', 'Only good for equality (=) lookups.']
  }
];
