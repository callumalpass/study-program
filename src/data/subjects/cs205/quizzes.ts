...
export const cs205Quizzes: Quiz[] = [
  // ============================================================================
    ...
    questions: [
      {
        ...
        options: ['Diamond', 'Rectangle', 'Oval', 'Triangle'],
        correctAnswer: 1,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Union', 'Intersection', 'Difference', 'Cartesian Product'],
        correctAnswer: 2,
    ...
    questions: [
      {
        ...
        options: ['COUNT(*)', 'COUNT(column)', 'SUM(column)', 'TOTAL(column)'],
        correctAnswer: 1,
...
WHERE Salary > (SELECT AVG(Salary) FROM Employees);`,
      ...
      },
      {
        ...
        options: ['WHERE', 'SELECT', 'FROM', 'HAVING'],
        correctAnswer: 2,
    ...
    questions: [
      {
        ...
        options: ['Dependent', 'Determinant', 'Key', 'Foreign key'],
        correctAnswer: 1,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Rotation', 'Split', 'Deletion', 'Compression'],
        correctAnswer: 1,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['B-tree', 'Hash', 'GIN/Full-text', 'Bitmap'],
        correctAnswer: 2,
    ...
    questions: [
      {
        ...
        options: ['Optimization', 'Execution', 'Parsing', 'Planning'],
        correctAnswer: 2,
    ...
    questions: [
      {
        ...
        options: ['SHOW PLAN', 'EXPLAIN', 'ANALYZE', 'DESCRIBE'],
        correctAnswer: 1,
