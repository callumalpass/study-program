...
export const cs304Quizzes: Quiz[] = [
  // ==================== TOPIC 1: Lexical Analysis ====================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['They are the same thing', 'A lexeme is the actual string; a token is its category', 'A token is the actual string; a lexeme is its category', 'Lexemes are only for keywords'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Parser', 'Scanner', 'Semantic analyzer', 'Optimizer'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Interpreters are faster', 'Compilers execute code directly', 'Interpreters execute without producing target code', 'Compilers cannot optimize'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Code optimization', 'Machine code generation', 'Analysis and IR generation', 'Linking'],
        correctAnswer: 2,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['DFAs are more powerful', 'NFAs have exactly one transition per symbol per state', 'DFAs have at most one transition per symbol per state', 'NFAs cannot have epsilon transitions'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['A transition that consumes any character', 'A transition that occurs without consuming input', 'A transition to an error state', 'A transition that matches whitespace'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['No, NFAs are more powerful', 'Yes, using subset construction', 'Only if the NFA has no epsilon transitions', 'Only for finite languages'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['abd or acd only', 'Strings starting with a, ending with d, with any b/c sequence in between', 'abcd only', 'Any string with a and d'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Prefer shorter tokens', 'Prefer longer tokens', 'Prefer alphabetically first tokens', 'Process one character at a time'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['yacc', 'bison', 'lex/flex', 'make'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Separate DFAs for each', 'Match as identifier, then check keyword table', 'Keywords have higher DFA priority', 'Keywords are handled by the parser'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Predicting future tokens', 'Reading ahead to decide current token boundaries', 'Caching tokens', 'Parallel scanning'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Terminating immediately on error', 'Discarding characters until a valid token start', 'Inserting missing characters', 'Switching to a backup scanner'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Only terminals', 'Only non-terminals', 'A single non-terminal', 'Any string of symbols'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['A grammar with errors', 'A grammar that can produce multiple parse trees for some input', 'A grammar with no valid derivations', 'A grammar with left recursion'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['The first terminal', 'The non-terminal from which all derivations begin', 'Any symbol can be the start', 'The most frequently used symbol'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Deriving left-recursive rules first', 'Always replacing the leftmost non-terminal', 'Starting from the left of the input', 'Using left-associative operators'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['The root node', 'The leftmost leaf', 'The string of terminals at the leaves read left to right', 'The number of nodes'],
        correctAnswer: 2,
    ...
    questions: [
      {
        ...
        options: ['They are ambiguous', 'They cause infinite recursion', 'They cannot express all languages', 'They are slower to parse'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['The first production for that symbol', 'The set of terminals that can begin strings derived from it', 'The first symbol in each production', 'The highest-priority terminal'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Never', 'When it can derive the empty string', 'When it appears in a production', 'When it is the start symbol'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Determining operator precedence', 'Deciding which production to use when FIRST sets overlap or contain ε', 'Detecting left recursion', 'Optimizing the parse table'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Left-to-right, Leftmost derivation, 1 symbol lookahead', 'Left-to-right, Left recursion, 1 pass', 'Linear time, Linear space, 1 table', 'Lexical, Logical, 1 phase'],
        correctAnswer: 0,
    ...
    questions: [
      {
        ...
        options: ['Push and pop', 'Read and write', 'Shift (push token) and reduce (apply production)', 'Accept and reject'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['The next token', 'A string matching a production\'s RHS that should be reduced', 'The stack top', 'An error condition'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Two reductions possible', 'Parser cannot decide between shifting and reducing', 'Invalid input detected', 'Stack overflow'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['lex', 'flex', 'yacc/bison', 'make'],
        correctAnswer: 2,
    ...
    questions: [
      {
        ...
        options: ['Computed from parent nodes', 'Computed from child nodes', 'Always constant', 'Only for terminals'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Computed from child nodes', 'Computed from parent or sibling nodes', 'Inherited from the grammar', 'Never changes'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A grammar with only synthesized attributes', 'A grammar with only string attributes', 'A simple grammar', 'A structured grammar'],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ['A left-recursive grammar', 'Attributes depend only on inherited from parent or synthesized from left siblings', 'A linear grammar', 'A grammar with lookahead'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A parse tree', 'A graph showing which attributes depend on which others', 'A control flow graph', 'A call graph'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Storing source code', 'Mapping identifiers to their attributes', 'Generating machine code', 'Parsing input'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Single global table', 'Stack of tables or chained hash tables', 'Array of identifiers', 'Binary search tree'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Types are equal if they have the same name', 'Types are equal if they have the same structure', 'Types are equal if declared together', 'Types are never equal'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Types are equal only if they have the same name', 'Types are equal if structurally identical', 'Types are equal if in the same scope', 'All types are equivalent'],
        correctAnswer: 0,
      ...
      },
      {
        ...
        options: ['Detecting type errors', 'Implicit conversion between types', 'Declaring types', 'Type inheritance'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Checking types at runtime', 'Checking types at compile time', 'Checking only static variables', 'Optional type checking'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['They are the same', 'AST omits syntactic details like parentheses', 'Parse tree is more compact', 'AST includes tokens'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A court ruling', 'An assertion that an expression has a certain type', 'A type error', 'A type definition'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Quicksort', 'Unification', 'Binary search', 'Gradient descent'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Creating ASTs', 'Traversing and operating on AST nodes', 'Parsing input', 'Memory management'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['To slow down compilation', 'To decouple front-end from back-end and enable optimization', 'IRs are required by language standards', 'To increase code size'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Code with three functions', 'IR where each instruction has at most three operands', 'Code for 3-bit machines', 'Assembly with three registers'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A simple function', 'A maximal sequence of instructions with one entry and one exit', 'A block of memory', 'The smallest unit of code'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A graph of function calls', 'A directed graph of basic blocks showing control flow', 'A data structure', 'A parse tree'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['High-level is faster', 'High-level preserves more source structure; low-level is closer to machine code', 'Low-level is more portable', 'They are the same'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Code with only one statement', 'Each variable is assigned exactly once in the program text', 'Single-threaded code', 'Code without loops'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A mathematical function', 'A function that selects a value based on control flow path taken', 'A hashing function', 'An optimization function'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['At function entries', 'At dominance frontiers of variable definitions', 'At loop exits', 'Everywhere'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Smaller code', 'Faster execution', 'Explicit def-use chains simplify many analyses', 'Fewer variables'],
        correctAnswer: 2,
      ...
      },
      {
        ...
        options: ['Deleting the IR', 'Converting back to non-SSA form by eliminating phi functions', 'Removing optimizations', 'Memory deallocation'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['A hardware description language', 'A typed, SSA-based IR used by LLVM compilers', 'A virtual machine', 'An assembly language'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['No difference', 'Quadruples store result name; triples use instruction position', 'Triples are larger', 'Quadruples are deprecated'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Reducing IR quality', 'Translating high-level constructs to lower-level operations', 'Compressing IR', 'Removing optimizations'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['The entry block', 'A block through which all paths to another block must pass', 'The most executed block', 'A recursive block'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['To confuse readers', 'Different optimizations work better at different abstraction levels', 'Required by standards', 'To increase compilation time'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Choosing which instructions to delete', 'Mapping IR operations to target machine instructions', 'Selecting the best algorithm', 'Choosing optimization levels'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Matching AST patterns', 'Covering IR trees with instruction tiles', 'Pattern matching in functional languages', 'Finding trees in code'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Use smallest instructions', 'Greedily select largest matching tile at each point', 'Random selection', 'Use most common instructions'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Simpler instruction selection', 'Complex instructions may do more work per instruction', 'Faster execution always', 'More registers'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Looking at small windows of instructions to improve them', 'Optimizing loops', 'Global analysis', 'Memory optimization'],
        correctAnswer: 0,
    ...
    questions: [
      {
        ...
        options: ['Registers are infinite', 'Registers are much faster than memory', 'Registers are required', 'Registers use less power'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A valid memory address', 'The interval from a variable\'s definition to its last use', 'A hardware register', 'A loop body'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Unrelated', 'Non-interfering live ranges can share registers (same color)', 'Colors represent memory', 'Graphs represent instructions'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Memory leak', 'Storing a value in memory when no register is available', 'Register overflow', 'Stack corruption'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Scanning registers linearly', 'A faster alternative to graph coloring using live intervals', 'Allocating registers in order', 'Sequential allocation'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Function naming', 'How arguments are passed and results returned between functions', 'Code formatting', 'Variable naming'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Same thing', 'Caller-saved are preserved by caller; callee-saved by callee', 'Caller-saved cannot be used', 'Callee-saved are for return values'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A log entry', 'Memory allocated for a function invocation', 'A hardware register', 'A calling convention'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Pointing to code', 'Providing a stable reference to the current stack frame', 'Pointing to globals', 'Heap management'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A fantasy creature', 'Executable and Linkable Format for Unix object files', 'An optimization', 'A virtual machine'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Folding code', 'Evaluating constant expressions at compile time', 'Reducing constants', 'Inlining constants'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Making code weaker', 'Replacing expensive operations with equivalent cheaper ones', 'Reducing variable count', 'Loop removal'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Removing duplicate code', 'Reusing previously computed values instead of recomputing', 'Removing comments', 'Simplifying expressions'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Removing syntax errors', 'Removing code whose results are never used', 'Removing comments', 'Removing old code'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Copying code', 'Replacing variable uses with their known values after assignment', 'Propagating errors', 'Memory copying'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Removing loops', 'Moving computations that don\'t change across iterations out of the loop', 'Loop parallelization', 'Loop counting'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A loop counter', 'A variable that changes by a constant amount each iteration', 'An initialized variable', 'A global variable'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Removing loops', 'Replicating the loop body to reduce iteration overhead', 'Flattening nested loops', 'Loop reversal'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Splitting loops', 'Combining adjacent loops with the same iteration space', 'Removing loops', 'Parallelizing loops'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Making loops tile-shaped', 'Improving cache locality by processing data in blocks', 'Dividing work among processors', 'Reducing loop count'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Checking if code is reachable', 'Finding which definitions may reach each program point', 'Defining reach', 'Code coverage'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Checking if variables exist', 'Determining which variables may be used before being redefined', 'Memory liveness', 'Variable counting'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Same direction', 'Forward propagates from entry; backward from exit', 'Forward is faster', 'Backward is more accurate'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Finding function aliases', 'Determining when pointers/references may refer to the same memory', 'Variable renaming', 'Type analysis'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Too many variables', 'Undecidable in general; must use conservative approximations', 'Requires too much memory', 'Not needed'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Function calls', 'Dynamically allocated data with programmer-controlled lifetime', 'Local variables', 'Constants'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Memory corruption', 'Wasted space due to allocation patterns', 'Memory overflow', 'Pointer errors'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Sweeping memory', 'Mark reachable objects, then sweep (free) unmarked objects', 'Marking errors', 'Memory cleanup'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Uses less memory', 'Compacts memory and has allocation cost proportional to live data', 'Never pauses', 'Simpler implementation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Object types', 'The hypothesis that most objects die young', 'Random selection', 'Object size'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['A VM using hardware stacks', 'A VM that uses a stack for operands instead of registers', 'A VM for stack languages', 'A VM with call stacks'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Binary code', 'Portable intermediate code for virtual machines', 'Compressed code', 'Encrypted code'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Ahead-of-time compilation', 'Compiling code to native during execution', 'Delayed compilation', 'Incremental compilation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A debugging JIT', 'A JIT that compiles frequently executed paths (traces)', 'A JIT with logging', 'A sequential JIT'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Compilation in tiers', 'Using multiple compilation levels based on method hotness', 'Parallel compilation', 'Incremental compilation'],
        correctAnswer: 1,
    ...
    questions: [
      {
        ...
        options: ['Compiling code', 'Combining object files and resolving external references', 'Running programs', 'Memory allocation'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Moving files', 'Adjusting addresses in object code when combined', 'Loading programs', 'Memory management'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Fast linking', 'Deferring library linking until runtime', 'Linking during compilation', 'Automatic linking'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['Relocatable code', 'Code that executes correctly regardless of its load address', 'Portable code', 'Optimized code'],
        correctAnswer: 1,
      ...
      },
      {
        ...
        options: ['A function table', 'A table of addresses for position-independent access to global data', 'A hash table', 'An optimization table'],
        correctAnswer: 1,
