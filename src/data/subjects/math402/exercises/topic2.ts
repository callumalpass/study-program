...
export const topic2Exercises: CodingExercise[] = [
  {
    ...
    description: 'Fundamental exercise for topic 2. Implement the basic algorithm for topic 2.',
    starterCode: `import numpy as np

def topic2_algorithm():
    """
    Implementation of topic 2 algorithm.
...
# Test cases
print("Testing topic 2 implementation")
# Add test cases
...
print("All tests passed!")`,
  ...
  },
  {
    ...
    topicId: 'topic-2',
    difficulty: 2,
    title: 'Topic 2 Exercise 2',
    description: 'Intermediate exercise for topic 2. Apply the algorithm to a more complex problem.',
    starterCode: `import numpy as np
