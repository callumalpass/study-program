...
- **S**: A start symbol (a distinguished non-terminal in N)
...
Where A is a non-terminal (the head or left-hand side) and α is a string of terminals and non-terminals (the body or right-hand side). The arrow means "can be replaced by" or "derives."
...
This notation indicates that A can be replaced by α₁, α₂, or α₃.
...
Here:
- Non-terminals: {E, T, F} representing expression, term, and factor
- Terminals: {+, *, (, ), id}
- Start symbol: E

This grammar captures operator precedence (multiplication before addition) and associativity through its structure.
