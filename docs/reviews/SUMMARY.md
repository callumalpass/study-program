...
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: ODE classification, first-order methods (separable, linear, exact), existence/uniqueness, second-order equations, higher-order equations, systems and eigenvalue methods, Laplace transforms, series solutions, applications
...
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: systems of linear equations, matrix operations, vector spaces, linear independence, determinants, eigenvalues/eigenvectors, linear transformations
  3. Specified assessment philosophy balancing computational fluency and conceptual understanding
  4. Defined exercise distribution (100% written) with 16 exercises per topic target
  5. Set exam targets (28 midterm, 42 final) matching existing content
  6. Documented that projects are not required (exam-only math subject)
- **Quality verified:** 81,587 total words (avg 1,665/subtopic), 112 exercises, 105 quiz questions, 70 exam questions
...
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: propositional logic, proof techniques, sets, relations, functions, predicate logic, sequences
  3. Specified assessment philosophy for foundational discrete math with CS applications
  4. Defined exercise distribution (100% written) with 20 exercises per topic target
  5. Set exam targets (26 midterm, 44 final) matching existing content
  6. Documented that projects are not required (exam-only math subject)
- **Quality verified:** 49,973 total words (avg 1,020/subtopic), 140 exercises, 105 quiz questions, 70 exam questions
...
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: graphics pipeline, transformations, viewing, rasterization, illumination, texture mapping, ray tracing
  3. Specified assessment philosophy for applied graphics programming
  4. Defined exercise distribution (85% coding with tests, 10% AI-evaluated, 5% written)
  5. Set project count to 3 (matching existing: Software Rasterizer, 3D Scene Viewer, Ray Tracer)
  6. Set exam targets (26 midterm, 42 final) matching existing content
- **Quality verified:** 105,821 total words (avg 2,160/subtopic), 112 exercises, 105 quiz questions, 68 exam questions, 3 projects
...
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: paradigms, type systems, functional programming, formal semantics, interpreters, memory management, advanced features
  3. Specified assessment philosophy balancing theory and implementation
  4. Defined exercise distribution (70% coding with tests, 15% AI-evaluated, 15% written)
  5. Set project count to 4 (matching existing: Interpreter, Type Inference, GC, VM/Compiler)
  6. Set exam targets (26 midterm, 42 final) matching existing content
- **Quality verified:** 75,931 total words (avg 1,550/subtopic), 112 exercises, 105 quiz questions, 68 exam questions, 4 projects
...
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: processes, threads, scheduling, synchronization, deadlock, memory management, virtual memory, file systems
  3. Specified assessment philosophy for mixed conceptual/implementation content
  4. Defined exercise distribution (70% coding with tests, 20% AI-evaluated, 10% written)
  5. Set project count to 2 (matching existing Process Scheduler and Virtual Memory Manager projects)
  6. Set exam targets (26 midterm, 42 final) matching existing content
- **Quality verified:** 63,576 total words (avg 1,297/subtopic), 112 exercises, 105 quiz questions, 68 exam questions, 2 projects

### CS205: Database Systems - Added Subject Specification
- **Status:** Already 10/10, now with complete subject-spec.yaml
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: relational model, SQL, normalization, ACID, indexing, optimization
  3. Specified assessment philosophy for mixed conceptual/practical content
  4. Defined exercise types (100% written/SQL, AI-evaluated)
  5. Set project count to 3 (matching existing projects)
  6. Set exam targets (26 midterm, 42 final) matching existing content
- **Quality verified:** 63,088 total words (avg 1288/subtopic), 112 exercises, 105 quiz questions, 68 exam questions, 3 projects

### CS204: Software Engineering - Added Subject Specification
- **Status:** Already 10/10, now with complete subject-spec.yaml
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: SDLC models, requirements engineering, design/UML, patterns, testing, CI/CD, Agile
  3. Specified assessment philosophy for mixed conceptual/practical content
  4. Defined exercise distribution (85% written, 15% AI-evaluated coding)
  5. Set project count to 3 (matching existing projects)
  6. Set exam targets (27 midterm, 43 final) matching existing content
- **Quality verified:** 88,190 total words (avg 1696/subtopic), 112 exercises, 105 quiz questions, 70 exam questions, 3 projects

### CS203: Theory of Computation - Added Subject Specification
- **Status:** Already 10/10, now with complete subject-spec.yaml
- **Changes made:**
  1. Created `subject-spec.yaml` with full pedagogical documentation
  2. Documented curriculum requirements: finite automata, regular languages, CFGs, PDAs, Turing machines, decidability, complexity
  3. Specified assessment philosophy for mixed theoretical/construction content
  4. Defined exercise distribution (100% written proofs/constructions)
  5. Set project count to 3 (matching existing simulators: FA, CFG Parser, TM)
  6. Set exam targets (26 midterm, 42 final) matching existing content
- **Quality verified:** 74,176 total words (avg 1514/subtopic), 112 exercises, 105 quiz questions, 68 exam questions, 3 projects
